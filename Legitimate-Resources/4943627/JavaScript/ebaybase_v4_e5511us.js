...
{if(!this.objType)
this.objType="EbayNSDetect";this.base=EbayBaseControl;this.base(pParent,pName);this.ebaysites=new RegExp("^(http[s]?:\\/\\/)?[\\w-.]+\\.(ebay(objects|motors|promotion|development|static|express|liveauctions|rtm)?)\\.[\\w-.]+($|\\/.*)","i");this.aRotationIDs=new Array();this.isTop=function(){var oD=this.oDocument,w=oD.win,d=oD.doc;var p=(w.parent==w);var o=(!(o==null||o==""||typeof(w.opener)=='undefined'));var r=d.referrer;if(p&&(!o||!(r==null&&r==""))){return true;}
else{return false;}}
this.init=function(){if(this.isTop()){this.track();}}
this.track=function(){var clientTime=new Date().getTime();var offset=this.getClientTimeOffset(clientTime);var tpim=this.getTpimCookielet(offset,clientTime);if(typeof(RoverNsCapable)=='undefined'&&(tpim==null||tpim=="")){var oD=this.oDocument,d=oD.doc,r=d.referrer;if(!(r==null||r==""||r.match(this.ebaysites))){this.writeImg();}}}
this.getTpimCookielet=function(cos,clientTime){var oCJ=ebay.oDocument.oCookieJar;var npiiCookieVal=oCJ.readCookie("npii");var tpimval=npiiCookieVal.replace(new RegExp("(.*\\^tpim\/)(.*)\\^"),"$2");var tpimexp=tpimval.substring(tpimval.length-8);var expTime=tpimexp.hex2Dec()*1000+cos*1000;var gmtDelta=expTime-clientTime;var expiredTime=15552000000;if(gmtDelta>expiredTime||gmtDelta<0){oCJ.writeCookielet("npii","tpim","");return"";}
return oCJ.readCookielet("npii","tpim");};this.addRotationId=function(pKey,pValue)
{this.aRotationIDs[pKey]=pValue;}
this.writeImg=function()
{var e=this.parent.oGlobals.oEnvironment;var d=(document.domain.has(e.sQADomain))?e.sQADomain:".";var im='<img width="1" height="1" src="'+e.sProtocol+'//rover'+d+'ebay.com/roverns/1/';im+=this.aRotationIDs[e.sCountry];im+='?mpvl='+encodeURIComponent(e.sLastPage);im+='&mpcl='+encodeURIComponent(e.sThisPage)+'">';this.oDocument.write(im);}
this.getClientTimeOffset=function(clientTime)
