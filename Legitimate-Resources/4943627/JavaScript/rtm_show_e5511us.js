...
{rtmArr1[i]=s;rtmArr2[i]="-1";if(this.rtms[i])
{if(this.rtms[i].sMinWidth!=0&&this.rtms[i].sMinHeight!=0)
rtmArr2[i]="-1";else
rtmArr2[i]="0:0";}}
...
{var bIsPopUnder=(pContentArr[i]!=-1&&pContentArr[i].indexOf(':')==0)?true:false;var isdc=(pContentArr[i]!=-1&&pContentArr[i].indexOf(';')==0)?true:false;if(pContentArr[i]==-1&&!document.layers)
...
pContentArr[i]=pContentArr[i].substring(1);aRTMInfos[i].sContent=pContentArr[i];aRTMInfos[i].bIsPopUnder=true;}
else
