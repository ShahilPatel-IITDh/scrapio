...
{var cnt=oGlobals.oEnvironment.sCountry;if(cnt=="ie"||l9%oConfig.countrySampleRate==6||MyEbayNextGenCheck())
...
this.MyEbayNextGenCheck=function(){var pbf=ebay.oDocument.oCookieJar.readCookielet("dp1","pbf");var bit=ebay.oDocument.oCookieJar.getBitFlag(pbf,21);return(bit==1);}
