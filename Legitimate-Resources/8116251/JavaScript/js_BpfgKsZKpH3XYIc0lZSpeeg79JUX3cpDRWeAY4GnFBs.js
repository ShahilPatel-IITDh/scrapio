...
/**
 * @file
 * Attaches behaviors load more button.
 */
...
(function ($, Drupal) {
  ...
  /**
   * Load more blocks on button click.
   */
  Drupal.behaviors.load_more_button = {
    attach: function (context) {
      $('.load-more-btn').once().each(function () {
        let block_content = $(this).data("block-content");
        $(this).on('click', function () {
          $.ajax({
            url: '/promoted-content/block/' + block_content + '/load-more',
