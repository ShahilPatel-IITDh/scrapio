...
if(T(_.nbP))nbR()
if(o=ckR('eTab821')>1&&!_.h23&&T('(actus|assistance|home|la-communaute|webmail)?@')&&_('#eThS')[0]){
...
RBOL+'~9','leadco@~9','.*'],
euR=ECR||T('[^/]*#'),
euS=!WMN&&!euR&&(_.rs||T("[^/]*@"))&&!T('(sso-client)?@/cas/|[^/]*home@'),
...
CN=H._(i=H._(i='#eTh-top>.EC>.NO')[0]?i:hS?'#eThS>.E>.N':'#N>div');if(!CN[0])CN=H._(i='ul.NO')
