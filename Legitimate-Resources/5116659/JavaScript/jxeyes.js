// JXEyes
// by Valerio Capello - https://labs.geody.com - r2018-06-07 fr2018-02-15
...
r=(dx*dx/jxeyem1w+dy*dy/jxeyem1h<1) ? 1 : Math.sqrt(jxeyem1w*jxeyem1h/(dx*dx*jxeyem1h+dy*dy*jxeyem1w));
jxeye1.style.left=r*dx+jxeye1pl+'px'; jxeye1.style.top=r*dy+jxeye1pt+'px';
dx-=jxxeyes;
r=(dx*dx/jxeyem2w+dy*dy/jxeyem2h<1) ? 1 : Math.sqrt(jxeyem2w*jxeyem2h/(dx*dx*jxeyem2h+dy*dy*jxeyem2w));
...
"<div id='jxeye1' style='position:absolute; left:"+jxeye1pl+"; top:"+jxeye1pt+"; z-index:6; width:"+jxeye1w+"; height:"+jxeye1h+";'>"+
"<img src='"+jxeyeimg1+"' width='"+jxeye1w+"' height='"+jxeye1h+"' alt='' id='img_jxeye1' />"+
"</div>"+
"<div id='jxeye2' style='position:absolute; left:"+jxeye2pl+"; top:"+jxeye2pt+"; z-index:6; width:"+jxeye2w+"; height:"+jxeye2h+";'>"+
"<img src='"+jxeyeimg2+"' width='"+jxeye2w+"' height='"+jxeye2h+"' alt='' id='img_jxeye2' />"+
"</div>"+
