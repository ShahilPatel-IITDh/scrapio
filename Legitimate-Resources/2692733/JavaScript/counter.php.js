if (!self._FC2COUNTER32163425_1)
{
	var _FC2COUNTER32163425_1 =
	{
		id:32163425,
		graph_img:null,
		show_graph:function(e)
		{
			if (this.graph_img == null )
			{
				...
				img.src = 'http://panel.counter1.fc2.com/popup.php?id=32163425&main=1&lang=0';
		...
		disp_js:function()
		{
			...
			document.write('<script type="text/javascript" language="javascript"'
				+ ' src="http://counter1.fc2.com/counter_js.php?id=32163425&main=1&lang=0'
				+ '&amp;visitor=' + this.visit_info()
				+ '" charset="UTF-8"></'+'script>');
			}else{
			const script = document.createElement('script');
			script.src = "http://counter1.fc2.com/counter_js.php?id=32163425&main=1&lang=0&visitor=" + this.visit_info();
