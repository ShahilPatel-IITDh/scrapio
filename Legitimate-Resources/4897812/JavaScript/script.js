...
$(document).ready(function(){
	...
	if(searchEngine=='google'){
		...
		search='https://search.yahoo.com/bin/search';
	}
	else{
		search='https://www.google.com/search';
		searchEngine='google';
	...
	$('#yahoo1').click(function() {
		$('#wrapper1 form').attr('action','https://search.yahoo.com/bin/search');
		$('#engines1').fadeToggle('fast','circEaseOut');
	...
	$('#wikipedia1').click(function() {
		$('#wrapper1 form').attr('action','https://www.wikipedia.org/search-redirect.php');
	...
	if(num>1){
		...
		$('#yahoo2').click(function() {
			$('#wrapper2 form').attr('action','https://search.yahoo.com/bin/search');
			$('#engines2').fadeToggle('fast','circEaseOut');
		...
		$('#wikipedia2').click(function() {
			$('#wrapper2 form').attr('action','https://www.wikipedia.org/search-redirect.php');
	...
	if(num>2){
		...
		$('#yahoo3').click(function() {
			$('#wrapper3 form').attr('action','https://search.yahoo.com/bin/search');
			$('#engines3').fadeToggle('fast','circEaseOut');
		...
		$('#wikipedia3').click(function() {
			$('#wrapper3 form').attr('action','https://www.wikipedia.org/search-redirect.php');
