...
Line 275:2 Transforming const to the configured target environment ("es5") is not supported yet
Line 431:8 Transforming const to the configured target environment ("es5") is not supported yet
Line 434:10 Transforming let to the configured target environment ("es5") is not supported yet
Line 869:56 Transforming destructuring to the configured target environment ("es5") is not supported yet
Line 870:10 Transforming const to the configured target environment ("es5") is not supported yet
Line 871:10 Transforming const to the configured target environment ("es5") is not supported yet
Line 876:19 Transforming object literal extensions to the configured target environment ("es5") is not supported yet
Line 877:8 Transforming const to the configured target environment ("es5") is not supported yet
Line 878:8 Transforming const to the configured target environment ("es5") is not supported yet
Line 881:10 Transforming const to the configured target environment ("es5") is not supported yet
... and 239 more hidden warnings
...
if (console && console.log) {
  console.log('Impulse theme ('+theme.settings.themeVersion+') by ARCHÎTYPE | Learn more at https://archetypethemes.co');
}
