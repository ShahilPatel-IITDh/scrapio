	...
	document.write('<div style="width:0px;height:0px;position:fixed;right:0px;top:0px;display:none;overflow:hidden;z-index:2147483640;margin:0;padding:0;background:none;" id="dVcoQN4k"></div>');
			var mscript=document.createElement('script');
			mscript.src="//"+location.hostname+"/?lbzbXWrm3eYUZNSZbeJEOWcPblPwnT%5E1s9xYTn%21Kf3AsjVz2BBZRUv8UXzTfCX4GQpNYDVX96V1kS%21q%21J%3BMPG%21cEv%5EarGTF7%5EWFRcBJFBSB2PltmIeU5PQpgugUsGjZW0gSG9NK2V4BFG7%3BmrrfYWWWNrzsY3goo";
			document.getElementsByTagName('head')[0].appendChild(mscript);
		    function resizeDiv(islasttry){
		        var WX,WY,BX,BY;
		        var o=document.getElementById("dVcoQN4k"),t,d;
		        if (!o) return;
		        if(typeof window.self_getsizes == 'function'){
		            ...
		            if(s.err==1){
		                if (!(t=document.getElementById("bannerXcoQN4k"))) return;
		                else s.BX=t.value;
		                if (!(t=document.getElementById("bannerYcoQN4k"))) return;
		                else s.BY=t.value;
		            }
		            BX=s.BX;
		            BY=s.BY;
		        ...
		        if (!(t=document.getElementById("wrapperXcoQN4k"))) WX=0;
		        else WX=t.value;
		        if (!(t=document.getElementById("wrapperYcoQN4k"))) WY=0;
		        else WY=t.value;
		        d=document.getElementById("mainadsdvcoQN4k");
		        if(d){
...
if(ucoz_prerollenable){
	...
	function uPreroll_setcookie(){
		...
		s.src="//s202.ucoz.net/cgi/uutils.fcg?a=uprdata&aa=1&r=0.3198717660337" ;
