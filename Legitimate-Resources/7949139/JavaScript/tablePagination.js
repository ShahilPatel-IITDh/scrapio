	...
	$.fn.tablePagination = function(settings) {
		...
		return this.each(function() {
			  ...
			  function createPaginationElements() {
				...
				htmlBuffer.push(defaults.perPageMsg);
				htmlBuffer.push("</span>");
				htmlBuffer.push("<span id='tablePagination_paginater'>");
				htmlBuffer.push("<div class='tablePagination_button' id='tablePagination_firstPage'/>");
				htmlBuffer.push("<div class='tablePagination_button' id='tablePagination_prevPage' />");
				htmlBuffer.push("<input id='tablePagination_currPage' type='input' value='"+currPageNumber+"' size='1'>");
				htmlBuffer.push(defaults.ofMsg);
				htmlBuffer.push(" <span id='tablePagination_totalPages'>"+totalPages+"</span>");
				htmlBuffer.push("<div class='tablePagination_button' id='tablePagination_nextPage' />");
				htmlBuffer.push("<div class='tablePagination_button' id='tablePagination_lastPage' />");
				htmlBuffer.push("</span>");
				htmlBuffer.push("</div>");
