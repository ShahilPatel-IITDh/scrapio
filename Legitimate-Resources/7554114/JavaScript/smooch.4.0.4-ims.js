...
/******/ 	__webpack_require__.p = "https://bot.pagofacil.de/IMChatBot/js/smoochjs/dist/";
/******/
...
var _webMessenger = __webpack_require__(4);

var _webMessenger2 = _interopRequireDefault(_webMessenger);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

if (window.__onWebMessengerHostReady__) {
    window.__onWebMessengerHostReady__(_webMessenger2.default);
} else if (true) {
    // Script loader wasn't found, host bundle is being used on its own.
    global['Smooch'] = _webMessenger2.default;
}
...
var _iframe = __webpack_require__(5);
...
var isPhantomJS = /PhantomJS/.test(navigator.userAgent) && "development" !== 'test';

var LIB_FUNCS = ['init', 'login', 'on', 'off', 'logout', 'autoLogin', 'sendMessage', 'updateUser', 'getConversation', 'getUser', 'getCore', 'open', 'close', 'isOpened'];
    ...
    if (!iframe) {
        ...
        iframe.onload = function () {
            if (!loaded) {
                ...
                doc.open();
                doc.write('\n                    <!DOCTYPE html>\n                    <html>\n                        <head>\n                            <link rel="stylesheet" href="' + 'https://bot.pagofacil.de/IMChatBot/js/smoochjs/dist/frame.4.0.4-ims.css' + '" type="text/css" />\n                            <script src="' + 'https://bot.pagofacil.de/IMChatBot/js/smoochjs/dist/frame.4.0.4-ims.min.js' + '" async crossorigin="anonymous"></script>\n                        </head>\n                        <body>\n                            <div id="mount"></div>\n                        </body>\n                    </html>\n                    ');
                doc.close();
            }
        };
    }
...
exports.use = exports.ref = function() {
	if(!(refs++)) {
		dispose = __webpack_require__(8)(content, {"insertAt":"bottom"});
	}
	return exports;
};
...
var _enquire = __webpack_require__(11);

var _enquire2 = _interopRequireDefault(_enquire);

var _sizes = __webpack_require__(15);
...
var MediaQueryDispatch = __webpack_require__(12);
...
var MediaQuery = __webpack_require__(13);
...
var QueryHandler = __webpack_require__(14);
...
/***/ })
/******/ ]);
//# sourceMappingURL=smooch.4.0.4-ims.js.map