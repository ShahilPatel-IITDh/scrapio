...
// Track script load
$.get(trackerUrl+'?ptrak_load');

// Track clicks
$('#jcornerBig').live('mousedown', function() {
	$.get(trackerUrl+'?ptrak_clicks');
	//window.setInterval("window.location.reload()",1000);
});

var jaaspeel = new Object();

jaaspeel.ad_url = escape('http://www.bethebosscanada.com/');
jaaspeel.small_path = 'http://www.bdc-canada.com/peel-q/peel/small.swf';
jaaspeel.small_image = escape('http://www.bdc-canada.com/peel-q/images/small.gif');
jaaspeel.small_width = '100';
jaaspeel.small_height = '100';
jaaspeel.small_params = 'ico=' + jaaspeel.small_image;

jaaspeel.big_path = 'http://www.bdc-canada.com/peel-q/peel/large.swf';
jaaspeel.big_image = escape('http://www.bdc-canada.com/peel-q/images/large.gif');
...
document.write(' codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=6,7,0,19,0"');
