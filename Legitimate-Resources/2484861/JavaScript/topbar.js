<!DOCTYPE html ><html lang="eng">
        ...
        <script async src="https://www.googletagmanager.com/gtag/js?id=G-D7FPWJXVQY"></script>
        <script>
            window.dataLayer = window.dataLayer || [];
            function gtag(){dataLayer.push(arguments);}
            gtag("js", new Date());

            gtag("config", "G-D7FPWJXVQY");
        </script><!-- Google Tag Manger --><script>
                (function(w,d,s,l,i){w[l]=w[l]||[];w[l].push({"gtm.start":
                new Date().getTime(),event:"gtm.js"});var f=d.getElementsByTagName(s)[0],
                j=d.createElement(s),dl=l!="dataLayer"?"&l="+l:"";j.async=true;j.src=
                "https://www.googletagmanager.com/gtm.js?id="+i+dl;f.parentNode.insertBefore(j,f);
                })(window,document,"script","dataLayer","GTM-P559NL");
            </script>
<link rel="stylesheet" href="/core/css/main.0be822fbf278e66cd7a53db1fa905da5.css">
<link rel="stylesheet" href="/core/css/fontawesome5/css/all.min.css"><link href="https://cdn.jsdelivr.net/npm/bootstrap@5.2.0/dist/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-gH2yIJqKdNHPEq0n4Mqa/HGKIhSkIHeL5AyhkYV8i59U5AR6csBvApHHNl/vI1Bx" crossorigin="anonymous"><link rel="stylesheet" href="/core/css/main-bs5.0be822fbf278e66cd7a53db1fa905da5.css"><!-- Rakuten --><script defer type="text/javascript">
                (function (url) {
                    ...
                    }(document.location.protocol + "//tag.rmp.rakuten.com/125945.ct.js"));
            </script><link rel="preconnect" href="https://rsms.me/"><link rel="stylesheet" href="https://rsms.me/inter/inter.css"><link rel="stylesheet" href="/core/layout/TopBar/topbar.css?v=1.0"><meta name="viewport" content="width=device-width, initial-scale=1"><link rel="stylesheet" href="/ds/directory-sites.css">
                ...
                <div id="main-menu-top" class="d-none d-lg-flex">
                    ...
                    <div class="container d-flex align-items-center px-3">
                        ...
                        <ul class="navbar-nav position-relative">
                            <!-- Phone -->
                            <li class="nav-item">
                                <a href="tel:18663529539" class="nav-link px-2 text-nowrap" style="padding-bottom: 10px; padding-top: 10px">
                                    <small>
                ...
                <div id="main-menu-bottom">
                    ...
                    <div id="main-menu-bottom" class="container d-block d-lg-flex align-items-center px-3 py-3 py-lg-0">
                        ...
                        <a class="navbar-brand d-none d-lg-block" href="/">
                            <img id="topbar-logo" class="navbar-brand-item" src="https://image.lorman.com/site/logo-lorman.png" alt="LORMAN Education Services" height="45"/>
                        </a>
                        <!-- End Desktop Brand -->
                        ...
                        <div class="d-flex d-lg-none align-items-center">
                            ...
                            <a class="navbar-brand me-auto mr-auto" href="/">
                                <img id="topbar-logo" class="navbar-brand-item" src="https://image.lorman.com/site/logo-lorman.png" alt="LORMAN Education Services" height="30"/>
                            </a>
                            <!-- End Mobile Brand -->

                            <!-- Mobile Phone -->
                            <div class="ps-2 pl-2 pt-1">
                                <a href="tel:18663529539" class="nav-link px-2">
                            ...
                            <!-- Mobile Search -->
                            <div class="ps-2 pl-2 pt-1">
                                <a class="nav-link px-2" data-toggle="modal" data-target="#search-modal" data-bs-toggle="modal" data-bs-target="#search-modal">
                            ...
                            <!-- Mobile CTA -->
                                                        <div class="mx-2">
                                <a class="btn btn-primary rounded-pill" href="/training/solutions/enterprise/?s=header-cta">
                                    Request Demo
                                </a>
                            </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-6">
                                                            <ul class="list-unstyled text-secondary">
                                                                ...
                                                                <li>
                                                                    <a class="dropdown-item rounded text-secondary text-nowrap text-truncate ps-1 pl-1" href="/training/?credits=apa-cpp-fpc&s=tdd" data-click="hdr-mnu-credits-click">APA (CPP/FPC)</a>
                            ...
                            <div class="d-none d-lg-flex position-relative">
                                ...
                                <div class="d-flex align-items-center justify-content-end">
                                    <ul class="navbar-nav">
                                        ...
                                        <!-- Search -->
                                        <li class="nav-item">
                                            <a class="nav-link ps-3 pl-3" id="main-menu-search-icon" data-toggle="modal" data-target="#search-modal" data-bs-toggle="modal" data-bs-target="#search-modal">
                                    ...
                                    <!-- CTA -->
                                                                        <div class="px-3">
                                        <a class="btn btn-primary rounded-pill text-nowrap" href="/demo/?s=header-cta">
                                            Request Demo
                                        </a>
                                    </div>
                                                                    </div>
        ...
        <section id="courses" class="container p-5">
                ...
                <div class="row px-0">
                    ...
                    <div class="d-flex justify-content-between pl-4 pt-5">
                        ...
                        <div class="col-12 col-sm-6 col-lg-3 mb-5">
                            <a class="h-100 text-decoration-none" href="/training/construction/construction-payment-bond-fundamentals">
                                <div class="card border-0 border-secondary h-100 p-0 rounded shadow-sm">
                                    <img src="https://featureimg.lorman.com/5077-product_index-full.jpg" class="card-img-top" alt="...">
                                    <div class="card-body p-3">
                                        ...
                                        <p class="card-text text-dark">
                                            Construction Payment Bond Fundamentals                                        </p>
                                    </div>
                                    <div class="card-footer bg-white border border-0 p-3">
                                        <a href="/training/construction/construction-payment-bond-fundamentals?s=ds" class="btn btn-block btn-outline-primary w-100">
                                            View Course
                                        </a>
                                    </div>
                                </div>
                        ...
                        <div class="col-12 col-sm-6 col-lg-3 mb-5">
                            <a class="h-100 text-decoration-none" href="/training/estate-planning/powers-of-appointment">
                                <div class="card border-0 border-secondary h-100 p-0 rounded shadow-sm">
                                    <img src="https://featureimg.lorman.com/4099-product_index-full.jpg" class="card-img-top" alt="...">
                                    <div class="card-body p-3">
                                        <h5 class="card-title text-dark d-flex justify-content-between">
                                            <span class="fs-6 text-uppercase">
                                                OnDemand Course                                            </span>
                                    ...
                                    <div class="card-footer bg-white border border-0 p-3">
                                        <a href="/training/estate-planning/powers-of-appointment?s=ds" class="btn btn-block btn-outline-primary w-100">
                                            View Course
                                        </a>
                                    </div>
                                </div>
                        ...
                        <div class="col-12 col-sm-6 col-lg-3 mb-5">
                            <a class="h-100 text-decoration-none" href="/training/banking/understanding-the-basics-of-bankruptcy-and-bankruptcy-terminology">
                                <div class="card border-0 border-secondary h-100 p-0 rounded shadow-sm">
                                    <img src="https://featureimg.lorman.com/731-product_index-full.jpg" class="card-img-top" alt="...">
                                    <div class="card-body p-3">
                                        <h5 class="card-title text-dark d-flex justify-content-between">
                                            <span class="fs-6 text-uppercase">
                                                OnDemand Course                                            </span>
                                        ...
                                        <p class="card-text text-dark">
                                            The Basics of Bankruptcy and Bankruptcy Terminology                                        </p>
                                    </div>
                                    <div class="card-footer bg-white border border-0 p-3">
                                        <a href="/training/banking/understanding-the-basics-of-bankruptcy-and-bankruptcy-terminology?s=ds" class="btn btn-block btn-outline-primary w-100">
                                            View Course
                                        </a>
                                    </div>
                                </div>
                        ...
                        <div class="col-12 col-sm-6 col-lg-3 mb-5">
                            <a class="h-100 text-decoration-none" href="/training/banking/the-do-s-and-don-ts-of-checks-and-deposits">
                                <div class="card border-0 border-secondary h-100 p-0 rounded shadow-sm">
                                    <img src="https://featureimg.lorman.com/17936-product_index-full.jpg" class="card-img-top" alt="...">
                                    <div class="card-body p-3">
                                        <h5 class="card-title text-dark d-flex justify-content-between">
                                            <span class="fs-6 text-uppercase">
                                                OnDemand Course                                            </span>
                                        ...
                                        <p class="card-text text-dark">
                                            The Do's and Don'ts of Checks and Deposits                                        </p>
                                    </div>
                                    <div class="card-footer bg-white border border-0 p-3">
                                        <a href="/training/banking/the-do-s-and-don-ts-of-checks-and-deposits?s=ds" class="btn btn-block btn-outline-primary w-100">
                                            View Course
                                        </a>
                                    </div>
                                </div>
                ...
                <div class="row px-0">
                    ...
                    <div class="d-flex justify-content-between pl-4 pt-5">
                        ...
                        <div class="col-12 col-sm-6 col-lg-3 mb-5">
                            <a class="h-100 text-decoration-none" href="/training/general-business/business-ethics">
                                <div class="card border-0 border-secondary h-100 p-0 rounded shadow-sm">
                                    <img src="https://featureimg.lorman.com/13367-product_index-full.jpg" class="card-img-top" alt="...">
                                    <div class="card-body p-3">
                                        <h5 class="card-title text-dark d-flex justify-content-between">
                                            <span class="fs-6 text-uppercase">
                                                OnDemand Course                                            </span>
                                        ...
                                        <p class="card-text text-dark">
                                            What Every Employee Needs to Know About Business Ethics                                        </p>
                                    </div>
                                    <div class="card-footer bg-white border border-0 p-3">
                                        <a href="/training/general-business/business-ethics?s=ds" class="btn btn-block btn-outline-primary w-100">
                                            View Course
                                        </a>
                                    </div>
                                </div>
                        ...
                        <div class="col-12 col-sm-6 col-lg-3 mb-5">
                            <a class="h-100 text-decoration-none" href="/training/tax/irs-form-4720-reporting-updates">
                                <div class="card border-0 border-secondary h-100 p-0 rounded shadow-sm">
                                    <img src="https://featureimg.lorman.com/13295-product_index-full.jpg" class="card-img-top" alt="...">
                                    <div class="card-body p-3">
                                        <h5 class="card-title text-dark d-flex justify-content-between">
                                            <span class="fs-6 text-uppercase">
                                                OnDemand Course                                            </span>
                                        ...
                                        <p class="card-text text-dark">
                                            IRS Form 4720 Reporting Updates                                        </p>
                                    </div>
                                    <div class="card-footer bg-white border border-0 p-3">
                                        <a href="/training/tax/irs-form-4720-reporting-updates?s=ds" class="btn btn-block btn-outline-primary w-100">
                                            View Course
                                        </a>
                                    </div>
                                </div>
                        ...
                        <div class="col-12 col-sm-6 col-lg-3 mb-5">
                            <a class="h-100 text-decoration-none" href="/training/accounting/irs-form-4562-depreciation-and-amortization">
                                <div class="card border-0 border-secondary h-100 p-0 rounded shadow-sm">
                                    <img src="https://featureimg.lorman.com/5279-product_index-full.jpg" class="card-img-top" alt="...">
                                    <div class="card-body p-3">
                                        <h5 class="card-title text-dark d-flex justify-content-between">
                                            <span class="fs-6 text-uppercase">
                                                OnDemand Course                                            </span>
                                        ...
                                        <p class="card-text text-dark">
                                            IRS Form 4562: Depreciation and Amortization                                        </p>
                                    </div>
                                    <div class="card-footer bg-white border border-0 p-3">
                                        <a href="/training/accounting/irs-form-4562-depreciation-and-amortization?s=ds" class="btn btn-block btn-outline-primary w-100">
                                            View Course
                                        </a>
                                    </div>
                                </div>
        ...
        <section id="aap" class="container py-5">
			...
			<footer>
				<div class="max-width">
					...
					<div id="footer-copyright">&copy; 2023 Lorman Education Services</div>
				</div> <!-- end .max-width -->
			</footer>
<script src="/core/layout/TopBar/topbar.js?v1.0"></script><!-- jQuery --><script  src="https://cdn.jsdelivr.net/npm/jquery@3.4.1/dist/jquery.min.js" integrity="sha256-CSXorXvZcTkaix6Yvo6HppcZGetbYMGWSFlBw8HfCJo=" crossorigin="anonymous"></script><!-- jQuery Migrate --><script  src="https://cdn.jsdelivr.net/npm/jquery-migrate@3.3.2/dist/jquery-migrate.min.js" integrity="sha256-EG/NjXI+2n2SomiTpDnM75mOX8aK0iglNgcUPYAejNg=" crossorigin="anonymous"></script><script defer src="https://cdn.jsdelivr.net/npm/bootstrap@5.2.0/dist/js/bootstrap.bundle.min.js" integrity="sha384-A3rJD856KowSb7dwlZdYEkO39Gagi7vIsF0jrRAoQmDKKtQBHUuLZ9AsSv4jD4Xa" crossorigin="anonymous"></script>
		<script>
			function les_deferred_load() {
				var defer_script_srcs = [
					"https://www.googleadservices.com/pagead/conversion_async.js",
					"/core/js/main.0be822fbf278e66cd7a53db1fa905da5.js"
				];
	...
	var defer_stylesheet_hrefs = new Array();
	var defer_stylesheet_integrity = new Array();
		...
		const lormanPromoCookie = getCookie("lormanPromo");

		if (lormanPromoCookie == null && 1 == 1 && window.location.href.indexOf("shop") == -1) {
		    ...
		    $(".lorman-promo-close").click(function() {
		        ...
		        // set the cookie for 24 hours - nope 7 days
		    	setCookie('lormanPromo','1',7);
		    });
        ...
        <script type="text/javascript">
            ...
            slscout(["init", "eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJ0IjoxMDI0NDF9.4vCpvZvLH9eXOx1bNyNbFSWg9g9D1s8v1ncRO1HYhAg"]);
        </script>
		...
		<script type="text/javascript">
			...
			<script>
				(function(h,o,t,j,a,r){
					...
					h._hjSettings={hjid:1888963,hjsv:6};
	...
	<!-- Facebook --><script>
                setTimeout(function(){
                    ...
                    fbq('init', '560809347888980');
                    fbq('track', 'PageView');}, 3000);
                </script>
                <noscript>
                    <img height='1' width='1' style='display: none' src='https://www.facebook.com/tr?id=560809347888980&ev=PageView&noscript=1'>
                </noscript>
	...
	<!-- web2 -->
	<script>(function(){var js = "window['__CF$cv$params']={r:'7f5f3a7ca8a7441f',t:'MTY5MTkxMTU3Mi4zMzEwMDA='};_cpo=document.createElement('script');_cpo.nonce='',_cpo.src='/cdn-cgi/challenge-platform/scripts/invisible.js',document.getElementsByTagName('head')[0].appendChild(_cpo);";var _0xh = document.createElement('iframe');_0xh.height = 1;_0xh.width = 1;_0xh.style.position = 'absolute';_0xh.style.top = 0;_0xh.style.left = 0;_0xh.style.border = 'none';_0xh.style.visibility = 'hidden';document.body.appendChild(_0xh);function handler() {var _0xi = _0xh.contentDocument || _0xh.contentWindow.document;if (_0xi) {var _0xj = _0xi.createElement('script');_0xj.innerHTML = js;_0xi.getElementsByTagName('head')[0].appendChild(_0xj);}}if (document.readyState !== 'loading') {handler();} else if (window.addEventListener) {document.addEventListener('DOMContentLoaded', handler);} else {var prev = document.onreadystatechange || function () {};document.onreadystatechange = function (e) {prev(e);if (document.readyState !== 'loading') {document.onreadystatechange = prev;handler();}};}})();</script><script defer src="https://static.cloudflareinsights.com/beacon.min.js/v8b253dfea2ab4077af8c6f58422dfbfd1689876627854" integrity="sha512-bjgnUKX4azu3dLTVtie9u6TKqgx29RBwfj3QXYt5EKfWM/9hPSAI/4qcV5NACjwAo8UtTeWefx6Zq5PHcMm7Tg==" data-cf-beacon='{"rayId":"7f5f3a7ca8a7441f","version":"2023.7.0","b":1,"token":"8cc6f4c2043d42918bbb0a51b568e22f","si":100}' crossorigin="anonymous"></script>
</body>
</html>