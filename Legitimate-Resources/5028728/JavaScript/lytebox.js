//**************************************************************************************************/
//	Lytebox v5.5 - Self-contained object that eliminated the dependency of prototype.js, effects.js, and scriptaculous.js.
//	Author: Markus F. Hay
...
function Lytebox(bInitialize, aHttp) {
	/*** Language Configuration ***/
		...
		this.label['prev'] 		= 'Précedent (\u2190)';	// Previous (left arrow)
		this.label['next'] 		= 'Suivant (\u2192)'; 		// Next (right arrow)
		this.label['play'] 		= 'Jouer (spacebar)';
