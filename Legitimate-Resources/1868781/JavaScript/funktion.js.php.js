...
""&&c.appendChild(d);c.className=this.selector.replace(".","_");c.className=c.className+" "+b;c.setAttribute("style","float:"+b);c.style.width=e+"px"}});/*** Content Hoehe ***/
$(document).ready(computecontent);
$(window).load(computecontent);
$(window).resize(computecontent);
function computecontent() {
	/*** L Nav height ***/
	var contheight = $('div#maincontent').height();
	if(($('div#maincontent').height() + $('div#footer').height() + $('div#header').height()) < $( window ).height() ){
		$minheight = $( window ).height() -($('div#footer').height() + $('div#header').height());
		$('div#maincontent').css({minHeight: $minheight});
	}

}
$( document ).ready(function() {
	$("button.togmenua").click(function() {
		$( "#togmenu" ).slideToggle( "slow" );
	});
});
