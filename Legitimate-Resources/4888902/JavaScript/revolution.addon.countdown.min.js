	   ...
	   if (ot==undefined) {    
	     o.html(nt);
	      ...
	      punchgs.TweenLite.fromTo(o,0.45,
	  		...
	  		{autoAlpha:1,rotationY:0,scale:1,ease:punchgs.Back.easeIn,onComplete:function() { o.html(nt);} });

	  punchgs.TweenLite.fromTo(o,0.45,
	  		{autoAlpha:1,rotationY:0,scale:1},
	  		{autoAlpha:1,rotationY:0,scale:1,ease:punchgs.Back.easeOut,delay:0 });
	      } else {
	         o.html(nt);
	      }
	   }
