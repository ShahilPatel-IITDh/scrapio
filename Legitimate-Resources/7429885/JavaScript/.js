	...
	document.write('<div style="width:0px;height:0px;position:fixed;right:0px;top:0px;display:none;overflow:hidden;z-index:2147483640;margin:0;padding:0;background:none;" id="dVc_XrRgG"></div>');
			var mscript=document.createElement('script');
			mscript.src="//"+location.hostname+"/?MbLJy%5EeP%3Besh14dtJz2LSASVVlZnFj%5EL6nFbGWNU%21VHsukJfBpcDmgk5TSW9lppdU59dlAsdj8ti4CsLBCqHC0YN6aQdxUeFmaK0OdDjayRsxRr6rKgAFnNWiaI80YzN1dY8P0h%3BRcp%3BNDeW7HPJZgoo";
			document.getElementsByTagName('head')[0].appendChild(mscript);
		    function resizeDiv(islasttry){
		        var WX,WY,BX,BY;
		        var o=document.getElementById("dVc_XrRgG"),t,d;
		        if (!o) return;
		        if(typeof window.self_getsizes == 'function'){
		            ...
		            if(s.err==1){
		                if (!(t=document.getElementById("bannerXc_XrRgG"))) return;
		                else s.BX=t.value;
		                if (!(t=document.getElementById("bannerYc_XrRgG"))) return;
		                else s.BY=t.value;
		            }
		            BX=s.BX;
		            BY=s.BY;
		        ...
		        if (!(t=document.getElementById("wrapperXc_XrRgG"))) WX=0;
		        else WX=t.value;
		        if (!(t=document.getElementById("wrapperYc_XrRgG"))) WY=0;
		        else WY=t.value;
		        d=document.getElementById("mainadsdvc_XrRgG");
		        if(d){
...
if(ucoz_prerollenable){
	...
	function uPreroll_setcookie(){
		...
		s.src="//s202.ucoz.net/cgi/uutils.fcg?a=uprdata&aa=1&r=0.380351190133712" ;
