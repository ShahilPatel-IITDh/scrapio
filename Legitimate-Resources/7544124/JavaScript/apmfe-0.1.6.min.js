...
function inheritPrototype(a,b){var c=Object.create(b.prototype);c.constructor=a,a.prototype=c}function getApmfeProjectId(){var a,b;try{return a=Sentry.getCurrentHub(),b=a.getClient(),b.ct.projectId}catch(c){return""}}function getApmfeFilename(a){try{const b=JSON.parse(a.body),c=b.exception.values[0].stacktrace.frames;return c.map(function(a){return a.filename}).reverse()}catch(d){return[]}}function getApmfeProject(a){var b,c,d,e;for(b=0;b<a.length;b+=1)for(c=a[b],d=0;d<apmfeProjectList.length;d+=1)if(e=apmfeProjectList[d].name,c.indexOf(e)>=0)return apmfeProjectList[d]}function getApmfeRequest(a,b){var c,d,e,f;try{if(c=getApmfeProjectId(),d=getApmfeFilename(b),!c||!d.length)return[a,b];if(e=new URL(a),f=getApmfeProject(d),!f)return[a,b];const g=new URLSearchParams(e.search.slice(1));g.delete("sentry_key"),g.append("sentry_key",f.token);const h=g.toString(),i=e.pathname.replace("/"+c+"/","/"+f.id+"/"),j=e.origin+i+"?"+h;return[j,b]}catch(k){return[a,b]}}function apmfeFetchImpl(a,b){const c=getApmfeRequest(a,b);return window.fetch(c[0],c[1])}function ApmfeTransport(a){Sentry.Transports.FetchTransport.call(this,a,apmfeFetchImpl)}function getStorage(a,b){var c=localStorage.getItem(a);return c?b?JSON.parse(c):c:b?{}:""}var apmfeProjectList=[{id:14,name:"/okfe/balance/",token:"90e92d576a744c048ef079540615e419"},{id:25,name:"/okfe/comb-trade/",token:"efc986e8cd9d46ae9aa1f455b6b0f383"},{id:32,name:"/okfe/defi-mode/",token:"78f39293a21b49f58a46fc3df0ae616c"},{id:35,name:"/okfe/p2p/",token:"a7469d35150046bcbf1f2827e2887018"},{id:36,name:"/okexchain/universe-swap/",token:"5402db24f78847a8bde4df03b259f3cc"},{id:64,name:"/okfe/invest/",token:"dd5871697f6c478d833bae9428428263"},{id:136,name:"/okfe/expressway/",token:"c3feecac5a4efc5c4f2340a1534da3ce"},{id:196,name:"/okfe/customer-service/",token:"b20d9b91c29b9810e01d642cc8b2abc1"}];inheritPrototype(ApmfeTransport,Sentry.Transports.FetchTransport),Sentry._init=Sentry.init,Sentry.init=function(a,b){var d,e,f,g,h,i,j,k,l,m,n,p,q,r,s,t,u,v,w,x,c=Boolean(b&&b.debug);if(a.transport=ApmfeTransport,!a.dsn)return Sentry._init(a),void 0;if(d=window._okGlobal||window.okGlobal||{},e=d?d.envSign||"":"",e&&(a.environment=e),f="",g=-1===a.dsn.indexOf("/apmfe")?"/apmfe":"",h=e.match(/daily/)?"sentry.coinall.ltd":document.domain,f=-1===a.dsn.indexOf(".ltd")?a.dsn.replace(/(https:)|(http:)/,document.location.protocol).replace(/@.*com?/,"@"+h+g):a.dsn.replace(/(https:)|(http:)/,document.location.protocol).replace(/@.*ltd?/,"@"+h+g),a.dsn=f,i=d?d.cdnBaseUrl:"",i&&"string"==typeof i&&(a.allowUrls=[window.origin,i]),c||!e.match(/daily/)){Sentry._init(a);try{j=getStorage("ok_global",!0),k=j.profile||{},l=k.uuid,m=k.lastLogin||{},l&&(n={id:l},m.ipAddress&&(n.ip_address=m.ipAddress),m.ipRegion&&(n.ip_region=m.ipRegion),m.loginDate&&(n.login_date=m.loginDate),k.loginName&&(n.login_name=k.loginName),Sentry.setUser(n))}catch(o){}try{for(p=window.navigator.userAgent,q=p.split(" "),r=0;r<q.length;r++)if(s=q[r]||"","OKApp"===s.slice(0,5)){Sentry.setTag("OKApp",s.slice(7,s.length-1));break}}catch(o){}try{"boolean"==typeof d.isApp&&Sentry.setTag("isApp",String(d.isApp)),t=getStorage("devId"),t&&Sentry.setTag("devId",t),u=getStorage("deviceId"),u&&Sentry.setTag("deviceId",u),v=getStorage("locale"),v&&Sentry.setTag("locale",v),w=navigator.connection.effectiveType,w&&Sentry.setTag("networkSpeed",w),x=Intl.DateTimeFormat().resolvedOptions().timeZone,x&&Sentry.setTag("timeZone",x)}catch(o){}}};
