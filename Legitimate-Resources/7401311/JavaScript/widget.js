        ...
        function(A, u) {
            (function(WlpInjectable, $, _) {
                ...
                var Widget = function(provider, jQEle) {
                    ...
                    /**
                     * @private
                     * Handles validations of the WLP request params e.g blank & empty string, default values etc.
                     * @param {Object} wlpConfig an object comprising the wlp request params
                     */
                    var validateWlpRequestParams = function(wlpConfig) {
                        if (wlpConfig) {
                            if(!wlpConfig.benefitOptimizationId || wlpConfig.benefitOptimizationId.trim().length === 0) {
                                delete wlpConfig.benefitOptimizationId;
                            }
                            if(!wlpConfig.planOptimizationId || wlpConfig.planOptimizationId.trim().length === 0) {
                                delete wlpConfig.planOptimizationId;
                            }
                        }
                    };
                    ...
                    this.register = function() {
                        ...
                        validateWlpRequestParams(config);
