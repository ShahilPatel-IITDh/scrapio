...
/*							 
	...
	$('#dropmenu li,#dyndropmenu li,.main-nav li').not('#tabs ul li.extended-menu ul li').hover(function(e) {
			$(this).find('ul:first').hoverFlow(e.type, { height: "show" }, 150, "easeInOutCubic");
			}, function(e) {
			$(this).find('ul:first').hoverFlow(e.type, { height: "hide" }, 250, "easeInBack");
	});
*/
});
...
/******************************************************************/
  ...
  $(document).ready(function () {
	$('#izmir_weather').weatherfeed(['TUXX0016']);
});
	...
	$('form#contactForm').submit(function() {
		...
		if(!hasError) {
			//$('form#contactForm li.buttons button').fadeOut('normal', function() {
				//$(this).parent().append('<img src="/main/themes/td-v3/images/template/loading.gif" alt="Loading&hellip;" height="31" width="31" />');
			//});
...
/******************************************************************/
/*	Accordion Gallery Based on Kwicks							  */
...
(function($) {
    $.fn.aToolTip = function(options) {
    	...
    	*/
		...
		if ( $('#'+objid).length ) { 
			var objx = $('#'+objid).offset().left;
		    var objy = $('#'+objid).offset().top;
		}
			/**			
			...
			*/
			var buildaToolTip = function(){
				$('body').append("<div id='"+settings.toolTipId+"' class='"+settings.toolTipClass+"'><p class='aToolTipContent'>"+tipContent+"</p><div class='"+settings.toolTipClass+"bottom'></div>");
...
/* Add a box (mouseTrap) over the small image to trap mouse events.
		...
		*/
        ...
        img2.src = jWin.attr('alt');
		linkim = jWin.attr('href');
    }
    ...
    $.fn.CloudZoom = function (options) {
        ...
        this.each(function () {
            ...
            if ($(this).is('.cloud-zoom')) {
				...
				var linkim;
				linkim = $(this).attr('href');
                if ($(this).parent().attr('id') != 'wrap') {
                    $(this).wrap('<a href="' + linkim + '"><div id="wrap" style="top:0px;z-index:9999;position:relative;"></div></a>');
                }
