...
<html lang="en">
	<head>
		...
		<title>QLeap.com domain name is for sale. Inquire now.</title>
		<meta name="description" content="QLeap.com is available for purchase. Get in touch to discuss the possibilities!">    
		...
		<script src='https://www.google.com/recaptcha/api.js'></script>
				...
				<link rel="canonical" href="http://www.sell.sawbrokers.com/domain/QLeap.com/" />
			...
			<div class="container h-100">
				...
				<div class="row align-items-center h-100">
					...
					<div class="col-12 col-lg-6 mx-auto">
						...
						<div class="mb-3">
							<h1 id="logo_text" class="mb-1 pt-3">QLeap.com</h1>	
							<h3 class="mb-4">Is For Sale</h3>
						</div>
						<p class="align-middle mb-4 bio mt-3">This premium domain name is available for purchase!</p>
														<p class="usp ml-4 mb-2"><i class="fas fa-chevron-right mr-2"></i> Qleap.com might be FOR SALE</p>
															<p class="usp ml-4 mb-2"><i class="fas fa-chevron-right mr-2"></i> For the best guaranteed price for Qleap.com inquire here</p>
					...
					<div class="col-12 col-lg-6 mx-auto">
						...
						<div class="jumbotron mb-0 mt-0 pt-4 pb-2">
								...
								<form action="ajaxa/landing_themes/add_inquiry_cap" method="post" class="odf_ajax" data-target="form_feedback" autocomplete="off" id="contact_form">                                                     			
									...
									<input type="hidden" name="domain_id" value="4369690">  
									...
									<div class="row">
										...
										<div class="col-sm-6">
											...
											<div class="form-group row mb-2">
												...
												<div class="col-sm-9">
													<input type="text" placeholder="Min: USD 1000.00" name="offer" id="offer" autocomplete="off" class="form-control" required>
												</div>
											</div>
...
<script>
	...
	$( document ).ready(function() {
		...
		Odf.ajax.get('https://sell.sawbrokers.com//ajax/visitors/create/', 'div#stats_div', { domain_id: '4369690' });
