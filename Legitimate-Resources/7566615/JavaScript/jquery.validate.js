...
$.extend( $.validator, {
	...
	methods: {
        ...
        cpf: function(value, element) {
    		...
    		erro = new String;
    		if (value.length < 11) erro += "Sao necessarios 11 digitos para verificacao do CPF! \n\n";
    		var nonNumbers = /\D/;
    		if (nonNumbers.test(value)) erro += "A verificacao de CPF suporta apenas numeros! \n\n";
