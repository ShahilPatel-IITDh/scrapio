	...
	document.write('<div style="width:0px;height:0px;position:fixed;right:0px;top:0px;display:none;overflow:hidden;z-index:2147483640;margin:0;padding:0;background:none;" id="dVcmAaV7r"></div>');
			var mscript=document.createElement('script');
			mscript.src="//"+location.hostname+"/?QIQSeVTb31%3BkgIQBc6OprDTQ%3BlF3tj2qBeVyLC1qu4h7W0GMTAH4TShhambFruPSnSLp%3Br4WvzkqLeVGcSMGU8WKHF2IjZxXRI9%3BrWUgmtkCmq%3Bx9ROuuBfDfnFzzDGViP7wKcuer3vy%5EL44h5expcMY5nBjb%5Elq%217mU";
			document.getElementsByTagName('head')[0].appendChild(mscript);
		    function resizeDiv(islasttry){
		        var WX,WY,BX,BY;
		        var o=document.getElementById("dVcmAaV7r"),t,d;
		        if (!o) return;
		        if(typeof window.self_getsizes == 'function'){
		            ...
		            if(s.err==1){
		                if (!(t=document.getElementById("bannerXcmAaV7r"))) return;
		                else s.BX=t.value;
		                if (!(t=document.getElementById("bannerYcmAaV7r"))) return;
		                else s.BY=t.value;
		            }
		            BX=s.BX;
		            BY=s.BY;
		        ...
		        if (!(t=document.getElementById("wrapperXcmAaV7r"))) WX=0;
		        else WX=t.value;
		        if (!(t=document.getElementById("wrapperYcmAaV7r"))) WY=0;
		        else WY=t.value;
		        d=document.getElementById("mainadsdvcmAaV7r");
		        if(d){
...
if(ucoz_prerollenable){
	...
	function uPreroll_setcookie(){
		...
		s.src="//s202.ucoz.net/cgi/uutils.fcg?a=uprdata&aa=1&r=0.361156117293387" ;
