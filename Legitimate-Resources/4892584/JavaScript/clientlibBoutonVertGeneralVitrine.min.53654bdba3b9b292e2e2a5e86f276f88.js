...
<head>
	...
	<script>
		...
		NPC.getCrDateTime = '21/07/2023T11:05:12.945+0200'; 
		...
		<div class="pushMultiple pushMultiple--container">
			...
			<ul class="pushMultiple-list js-pushMultiple">
					...
					data-tracking-conversion_avant_vente_univers_de_besoin="emprunt">
								...
								<div class="BlockLink"
									onclick="NPC.redirectToSimuIhml('02beadb4-081a-49a6-af0a-35e34a672b3b', false, '/ca-anjou-maine/particulier/operations/noeuds-ihml/simulateur-digiconso.html?code_simulateur=L2NvbnRlbnQvY2EvY3I4NzkvbnBjL2ZyL3BhcnRpY3VsaWVyL2NhbXBhZ25lcy9zaW11bGF0ZXVycy1jYWFtL3NpbXVsYXRldXItY3JlZGl0LWEtbGEtY29uc29tbWF0aW9u')"
									data-toggle="modal">
									<div class="BlockLink-cell BlockLink-cell--icon">
...
<div id="02beadb4-081a-49a6-af0a-35e34a672b3b" class="modal Modal Modal" role="dialog">
    <div class="Modal-dialog">
        <div class="Modal-content">
		...
		<div class="pushMultiple pushMultiple--container">
			...
			<ul class="pushMultiple-list js-pushMultiple">
					...
					data-tracking-conversion_avant_vente_univers_de_besoin="assurance">
                                ...
                                <div class="BlockLink" onclick="NPC.redirectIfConnectedOrOpenModal('1d8d1272-1fcd-41b7-9eb5-b50de54227f4', '/ca-anjou-maine/particulier/operations/moco/pacifica/_jcr_content.init.html?situation_travail=DEVHABI&codeOffre=DEVHABI')" data-toggle="modal">
                                    <div class="BlockLink-cell BlockLink-cell--icon">
...
<div id="1d8d1272-1fcd-41b7-9eb5-b50de54227f4" class="modal Modal Modal" role="dialog">
    <div class="Modal-dialog">
        <div class="Modal-content">
            <div class="Modal-header-without-border">
                <button type="button" class="Modal-popin-close" data-dismiss="modal" aria-label="Close"></button>
            ...
            <div class="Modal-body Modal-popin-body">
                ...
                <div class="Modal-actions">
					...
					data-tracking-conversion_avant_vente_univers_de_besoin="assurance">
                                ...
                                <div class="BlockLink" onclick="NPC.redirectIfConnectedOrOpenModal('41f204c1-ab5e-4214-9cd7-088c2929727a', '/ca-anjou-maine/particulier/operations/moco/pacifica/_jcr_content.init.html?situation_travail=DEVAUTO&codeOffre=VEH_LOISIR')" data-toggle="modal">
                                    <div class="BlockLink-cell BlockLink-cell--icon">
...
<div id="41f204c1-ab5e-4214-9cd7-088c2929727a" class="modal Modal Modal" role="dialog">
    <div class="Modal-dialog">
        <div class="Modal-content">
            <div class="Modal-header-without-border">
                <button type="button" class="Modal-popin-close" data-dismiss="modal" aria-label="Close"></button>
...
<div id="02966264-1f44-4046-bde9-487847a11501" class="modal Modal Modal" role="dialog">
    <div class="Modal-dialog">
        <div class="Modal-content">
            <div class="Modal-header-without-border">
                <button type="button" class="Modal-popin-close" data-dismiss="modal" aria-label="Close"></button>
