...
<head>
	...
	<script>
		...
		NPC.getCrDateTime = '21/07/2023T11:05:49.991+0200'; 
		...
		<div class="pushMultiple pushMultiple--container">
			...
			<ul class="pushMultiple-list js-pushMultiple">
					...
					data-tracking-conversion_avant_vente_univers_de_besoin="emprunt">
								...
								<div class="BlockLink"
									onclick="NPC.redirectToSimuIhml('31ca34f8-23f7-4cbd-886e-87b2b9e0725d', false, '/ca-anjou-maine/particulier/operations/noeuds-ihml/simulateur-digiconso.html?code_simulateur=L2NvbnRlbnQvY2EvY3I4NzkvbnBjL2ZyL3BhcnRpY3VsaWVyL2NhbXBhZ25lcy9zaW11bGF0ZXVycy1jYWFtL3NpbXVsYXRldXItY3JlZGl0LWEtbGEtY29uc29tbWF0aW9u')"
									data-toggle="modal">
									<div class="BlockLink-cell BlockLink-cell--icon">
...
<div id="31ca34f8-23f7-4cbd-886e-87b2b9e0725d" class="modal Modal Modal" role="dialog">
    <div class="Modal-dialog">
        <div class="Modal-content">
		...
		<div class="pushMultiple pushMultiple--container">
			...
			<ul class="pushMultiple-list js-pushMultiple">
					...
					data-tracking-conversion_avant_vente_univers_de_besoin="assurance">
                                ...
                                <div class="BlockLink" onclick="NPC.redirectIfConnectedOrOpenModal('f3eb7b49-40a0-4994-92f0-616bb4a9b6a7', '/ca-anjou-maine/particulier/operations/moco/pacifica/_jcr_content.init.html?situation_travail=DEVHABI&codeOffre=DEVHABI')" data-toggle="modal">
                                    <div class="BlockLink-cell BlockLink-cell--icon">
...
<div id="f3eb7b49-40a0-4994-92f0-616bb4a9b6a7" class="modal Modal Modal" role="dialog">
    <div class="Modal-dialog">
        <div class="Modal-content">
            <div class="Modal-header-without-border">
                <button type="button" class="Modal-popin-close" data-dismiss="modal" aria-label="Close"></button>
            ...
            <div class="Modal-body Modal-popin-body">
                ...
                <div class="Modal-actions">
					...
					data-tracking-conversion_avant_vente_univers_de_besoin="assurance">
                                ...
                                <div class="BlockLink" onclick="NPC.redirectIfConnectedOrOpenModal('890cb7ca-9e61-491b-9977-3791d8b150f7', '/ca-anjou-maine/particulier/operations/moco/pacifica/_jcr_content.init.html?situation_travail=DEVAUTO&codeOffre=VEH_LOISIR')" data-toggle="modal">
                                    <div class="BlockLink-cell BlockLink-cell--icon">
...
<div id="890cb7ca-9e61-491b-9977-3791d8b150f7" class="modal Modal Modal" role="dialog">
    <div class="Modal-dialog">
        <div class="Modal-content">
            <div class="Modal-header-without-border">
                <button type="button" class="Modal-popin-close" data-dismiss="modal" aria-label="Close"></button>
...
<div id="964084b9-9cfe-4d55-bf9e-0be155b4eb02" class="modal Modal Modal" role="dialog">
    <div class="Modal-dialog">
        <div class="Modal-content">
            <div class="Modal-header-without-border">
                <button type="button" class="Modal-popin-close" data-dismiss="modal" aria-label="Close"></button>
