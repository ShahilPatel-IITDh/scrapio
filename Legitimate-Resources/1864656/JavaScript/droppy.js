...
$(function() {
	...
	$('#navigation ul>li>a').hover(function() { //mouse in
		$(this).animate({ paddingLeft: '15px' }, 200);
	}, function() { //mouse out
	$(this).stop().animate({ paddingLeft: '6px' }, 200);
	});
...
$(function() {
	...
	$('.widget-list>li>a').hover(function() { //mouse in
		$(this).animate({ paddingLeft: '10px' }, 200);
	}, function() { //mouse out
	$(this).stop().animate({ paddingLeft: '0px' }, 200);
	});
	
	$('.selected>a').hover(function() { //mouse in
