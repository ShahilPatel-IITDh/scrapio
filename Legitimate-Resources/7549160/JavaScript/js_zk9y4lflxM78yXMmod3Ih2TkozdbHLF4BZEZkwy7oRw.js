...
(function ($, Drupal) {
  ...
  Drupal.behaviors.adminToolbarSearch = {
    ...
    attach: function (context) {
      ...
      $('#admin-toolbar-search-input').keypress(function (e) {
        if (e.which == 13) {
          var text = $('#admin-toolbar-search-input').val()
          location.href = 'https://kando.tech/search/content?search_api_fulltext_op=and&search_api_fulltext='+text
          return false;
        }
      })
    }
