...
;
Drupal.locale = { 'strings': { "Unspecified error": "Tanımlanamayan hata", "Drag to re-order": "Yeniden sıralamak için sürükleyiniz", "Changes made in this table will not be saved until the form is submitted.": "Bu tabloda yapılan değişiklikler form gönderilenceye dek kaydedilmeyecektir.", "Select all rows in this table": "Bu tablodaki tüm satırları seç", "Deselect all rows in this table": "Tablodaki satır seçimini iptal et", "Split summary at cursor": "Özeti buradan itibaren kes", "Only files with the following extensions are allowed: %files-allowed.": "İzin verilen dosya türleri: %files-allowed.", "This field is required.": "Bu alan zorunludur.", "The changes to these blocks will not be saved until the \x3cem\x3eSave blocks\x3c/em\x3e button is clicked.": "Bloklarda yapılan değişiklikler, \x3cem\x3eBlokları kaydet\x3c/em\x3e düğmesi tıklanıncaya dek kaydedilmez.", "Upload": "Yükleme", "Join summary": "Özeti birleştir", "OK": "Tamam", "Close": "Kapat", "Editor name": "Editör adı", "Loading...": "Yükleniyor...", "unlimited": "limitsiz" } };;
// $Id$
