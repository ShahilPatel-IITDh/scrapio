...
}catch(e){console.log("Module 'bco_faqs_fenix': ",e);}
...
try{"use strict";function _toConsumableArray(e){return _arrayWithoutHoles(e)||_iterableToArray(e)||_nonIterableSpread()}function _nonIterableSpread(){throw new TypeError("Invalid attempt to spread non-iterable instance")}function _iterableToArray(e){if(Symbol.iterator in Object(e)||"[object Arguments]"===Object.prototype.toString.call(e))return Array.from(e)}function _arrayWithoutHoles(e){if(Array.isArray(e)){for(var a=0,t=new Array(e.length);a<e.length;a++)t[a]=e[a];return t}}function cambiarCanalDigital(){_toConsumableArray(document.getElementsByClassName("canal")).forEach(function(e,a){e.classList.remove("canal-active"),e.classList.add("canal-inactive")}),document.getElementById("canalDigitales").classList.add("canal-active"),document.getElementById("canalDigitales").classList.remove("canal-inactive"),_toConsumableArray(document.getElementsByClassName("canales-contenido")).forEach(function(e,a){e.classList.remove("canales-contenido-active")}),document.getElementById("canalesDigitales").classList.add("canales-contenido-active"),_toConsumableArray(document.getElementsByClassName("imageCanal")).forEach(function(e,a){e.classList.remove("imageActive")}),document.getElementById("imagenDigitales").classList.add("imageActive")}function cambiarCanalTelefonico(){_toConsumableArray(document.getElementsByClassName("canal")).forEach(function(e,a){e.classList.remove("canal-active"),e.classList.add("canal-inactive")}),document.getElementById("canalTelefonicos").classList.remove("canal-inactive"),document.getElementById("canalTelefonicos").classList.add("canal-active"),_toConsumableArray(document.getElementsByClassName("canales-contenido")).forEach(function(e,a){e.classList.remove("canales-contenido-active")}),document.getElementById("canalesTelefonicos").classList.add("canales-contenido-active"),_toConsumableArray(document.getElementsByClassName("imageCanal")).forEach(function(e,a){e.classList.remove("imageActive")}),document.getElementById("imagenTelefonicos").classList.add("imageActive")}function cambiarCanalFisico(){_toConsumableArray(document.getElementsByClassName("canal")).forEach(function(e,a){e.classList.remove("canal-active"),e.classList.add("canal-inactive")}),document.getElementById("canalFisicos").classList.remove("canal-inactive"),document.getElementById("canalFisicos").classList.add("canal-active"),_toConsumableArray(document.getElementsByClassName("canales-contenido")).forEach(function(e,a){e.classList.remove("canales-contenido-active")}),document.getElementById("canalesFisicos").classList.add("canales-contenido-active"),_toConsumableArray(document.getElementsByClassName("imageCanal")).forEach(function(e,a){e.classList.remove("imageActive")}),document.getElementById("imagenFisicos").classList.add("imageActive")}BcAccordionBehavior.setUpAll();
}catch(e){console.log("Module 'bco_faqs_fenix': ",e);}
try{(function(_1,_2){
