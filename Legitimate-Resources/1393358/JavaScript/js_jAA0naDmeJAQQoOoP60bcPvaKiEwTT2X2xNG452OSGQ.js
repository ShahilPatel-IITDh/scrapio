 ...
 * 20181017 - ARJ - Web18 - jQuery event aliases like .load, .unload or .error deprecated since jQuery 1.8.
 * 20181017 - ARJ - Web18 - Fixed missing semi colons and removed supurflous commas
 *
 */
    ...
    $.fn[ pluginName ] = function ( options ) {
        ...
        function setup(obj) {
            ...
            for (var k in obj_list) {
              if (obj_list.hasOwnProperty(k)) {
                var max = 0;
                // find the largest height...
                for (var i in obj_list[k]) {
                  if (obj_list[k].hasOwnProperty(i)) {
                    var h = $(obj_list[k][i]).height();
                    if (h >= max) {
                        max = h;
                    }
                  }
...
// jQuery event aliases like .load, .unload or .error deprecated since jQuery 1.8. - ARJ 20181017 (web18)
...
;
!function(c,t){"use strict";function o(t,e,n){t.each(function(){e.push(c(this).height())});n=Math.max.apply(null,e);t.each(function(){c(this).find(".paragraph--type--bp-rich-text").css("min-height",n+"px")})}t.behaviors.santander_web18_2_0={attach:function(t){var e=(c("#toolbar-bar").find(".toolbar-tab").outerHeight()||0)+(c(".is-active.toolbar-tray-horizontal").outerHeight()||0);c("body").css({"padding-top":e}),c(".path-user .user-login-form .form-item-name label").before().html('<span class="glyphicon glyphicon-user" aria-hidden="true"></span> Username'),c(".path-user .user-login-form .form-item-pass label").before().html('<span class="glyphicon glyphicon-lock" aria-hidden="true"></span> Password')}},c(function(){c(".js-sticky").sticky({topSpacing:0})}),c(function(){c(document).ready(function(){c(document).on("click",".btn-bp-popover",function(){return!1}),c(".btn-bp-popover").popover({placement:"bottom",trigger:"click",html:!0,title:function(){return c(this).parent().find(".bp-popover--head").html()},content:function(){return c(this).parent().find(".bp-popover--body").html()}}),c(document).on("click",".popover .btn-popover-close",function(){return c(this).parents(".popover").popover("hide"),!1})})}),c(function(){c(document).ready(function(){c(".header__button").click(function(){c(this).toggleClass("active")})})}),c(function(){c(document).ready(function(){var i=null,s=null,t=new MutationObserver(function(t){var o=".block-views-exposed-filter-blocksantander-search-database-page-1.bp-search--bar form ",e=(t.forEach(function(t){var e,n,t=t.target;null!=t&&"none"!==t.style.display?(c(o).addClass("autocomplete-active"),0==c(".page-search-container").length?window.innerWidth<=768&&null!=s&&null!=i?r():0<c(".menu--support").length&&(t=c(".menu--support")[0],e=s.offsetWidth+2*t.offsetWidth,t=s.getBoundingClientRect().left-2*t.offsetWidth,n=c(s).position().top+c(s).offset().top+c(s).outerHeight(!0),i.style.top=n+"px",i.style.width=e+"px",i.style.left=t+"px"):null!=s&&null!=i&&r()):c(o).removeClass("autocomplete-active")}),c(o+".form-item input").val());c.fn.wrapInTag=function(e){var t=e.tag||"strong",n=e.words||[],o=new RegExp(n.join("|"),"gi"),a="<"+t+">$&</"+t+">";c(this).contents().each(function(){var t;3===this.nodeType?c(this).replaceWith(((t=this).textContent||t.innerText).replace(o,a)):e.ignoreChildNodes||c(this).wrapInTag(e)})};for(var n=0;n<c("ul.search-api-autocomplete-search .ui-menu-item").length;n++){var a=c("ul.search-api-autocomplete-search .ui-menu-item .ui-menu-item-wrapper .search-api-autocomplete-suggestion span")[n];c(a).wrapInTag({words:[e]})}}),i=document.getElementsByClassName("search-api-autocomplete-search")[0],e=".block-views-exposed-filter-blocksantander-search-database-page-1.bp-search--bar .input-group form ";function r(){var t,e,n;null!=s&&(t=s.offsetWidth,e=s.getBoundingClientRect().left,n=c(s).position().top+c(s).offset().top+c(s).outerHeight(!0),i.style.top=n+"px",i.style.width=t+"px",i.style.left=e+"px")}null!=i&&t.observe(i,{attributes:!0,attributeFilter:["style"]}),s=c(e+".form-item input")[0],0<c(e+".form-item input").length&&(c(e+".form-item input").wrap('<span class="clearable" />').after(c('<i class="clearable__clear">&times;</i>')),c(".clearable").each(function(){const e=c(this).find("input:text"),t=c(this).find(".clearable__clear");e.on("input",function(){t.toggle(!!this.value)}),t.on("touchstart click",function(t){t.preventDefault(),e.val("").trigger("input")})}),c(e+".form-item input").focus(function(){c(e+".form-actions input[type='submit']").addClass("isFocus")}),c(e+".form-item input").focusout(function(){c(e+".form-actions input[type='submit']").removeClass("isFocus")}),window.addEventListener("resize",function(){var t,e,n;0==c(".page-search-container").length?null!=i&&("none"!==i.style.display&&window.innerWidth<=768?r():0<c(".menu--support").length&&(e=c(".menu--support")[0],t=s.offsetWidth+2*e.offsetWidth,e=s.getBoundingClientRect().left-2*e.offsetWidth,n=c(s).position().top+c(s).offset().top+c(s).outerHeight(!0),i.style.top=n+"px",i.style.width=t+"px",i.style.left=e+"px")):null!=i&&"none"!==i.style.display&&r()}))})}),c(function(){c(document).ready(function(){c("a.navigation__item-menu-close").each(function(){c(this).on("click",function(){c(".dropdown-menu").each(function(){991<c(window).outerWidth()&&c(this).removeClass("open").fadeOut(500)})})}),c(".navigation__item.dropdown").mouseover(function(){c(".navigation__item-menu.dropdown-menu").removeAttr("style")})})}),c(function(){c(".navigation__item .navigation__item-link").hover(function(){document.documentElement.clientWidth<=991&&"/personal/support/contact-us"!==this.getAttribute("href")?c(this).attr("data-toggle","dropdown"):c(this).attr("data-toggle","")})}),c(function(){c(document).ready(function(){c(".views-product-list-credit-cards .eligibility a").each(function(){var t=c(this).attr("name");null!==t&&c(this).text(t)})})}),c(function(){c(document).ready(function(){var e=c(".sp-mobile-demo .carousel-sync"),t=c(".sp-mobile-demo__slides"),n=c(".sp-mobile-demo__text .carousel-indicators li"),o=0;function a(){n.each(function(t){c(this).hasClass("active")&&(o=parseInt(c(this).attr("data-slide-to"),10))}),0===o?(t.children(".carousel-control.left").hide(),t.children(".carousel-control.next-guide").hide(),t.children(".carousel-control.right").show()):(o===n.length-1?(t.children(".carousel-control").show(),t.children(".carousel-control.right")):(t.children(".carousel-control").show(),t.children(".carousel-control.next-guide"))).hide()}c(".sp-mobile-demo .carousel-control").click(function(){var t=c(this).attr("data-slide");e.not(".sliding").carousel(t)}),c("#text-carousel .carousel-indicators li").click(function(){var t=c(this).attr("data-slide-to");c("#slide-carousel").carousel(parseInt(t,10))}),a(),c("#text-carousel").on("slid.bs.carousel",a)})}),c(function(){c(document).ready(function(){c(".bp-blue-wrapper .row").each(function(t){c(this).find(".col-md-6:nth-child(2) .paragraph").addClass("second_element")})})}),c(function(){var t=c(".paragraph--type--bp-carousel .carousel-item"),e=[],n=(n=!1,n=!!(0<window.navigator.userAgent.indexOf("MSIE ")||navigator.userAgent.match(/Trident.*rv\:11\./))||n);t.length&&!n&&(992<=c(window).width()&&o(t,e),c(window).on("resize orientationchange",function(){992<=c(window).width()?(e.length=0,t.each(function(){c(this).find(".paragraph--type--bp-rich-text").css("min-height","auto")}),o(t,e)):t.each(function(){c(this).find(".paragraph--type--bp-rich-text").css("min-height","auto")})}))}),c(function(){c(".paragraph--type--bp-carousel").on("touchstart",function(t){var e=t.originalEvent.touches[0].pageX;c(this).one("touchmove",function(t){t=t.originalEvent.touches[0].pageX;5<Math.floor(e-t)?c(this).carousel("next"):Math.floor(e-t)<-5&&c(this).carousel("prev")}),c(".carousel").on("touchend",function(){c(this).off("touchmove")})})}),c(function(){var t=c(".paragraph--type--bp-carousel .two-col");t.length&&t.each(function(){var t=c(this).find(".col-md-6.col-1").children(),e=t.length,n=c(this).find(".col-md-6.col-2"),o=n.children();1===o.length&&("embedded-entity"===o[0].className||"IMG"===o[0].nodeName||"P"===o[0].nodeName&&1===o[0].childElementCount&&"IMG"===o[0].firstChild.nodeName)&&(1<e||1===e&&"embedded-entity"!==t[0].className)&&(c(this).prepend(n.clone().addClass("col-0").addClass("show_mobile").removeClass("col-2")),n.addClass("show_desktop"))})}),c(function(){c(document).ready(function(){var t=window.location.pathname;t.startsWith("/business")||t.startsWith("/select")||(c("#block-santander-web18-2-0-main-menu > ul > li.mega-menu.active > a").attr("href","/"),t.startsWith("/business"))||t.startsWith("/select")||(c("#block-santander-web18-2-0-main-menu > ul > li.mega-menu.active > a").attr("href","/"),t.startsWith("/personal/current-accounts")?c('.navigation__item-link[href="/personal/current-accounts"]').addClass("active"):t.startsWith("/personal/credit-cards")?c('.navigation__item-link[href="/personal/credit-cards"]').addClass("active"):t.startsWith("/personal/insurance")?c('.navigation__item-link[href="/personal/insurance"]').addClass("active"):t.startsWith("/personal/loans")?c('.navigation__item-link[href="/personal/loans"]').addClass("active"):t.startsWith("/personal/mortgages")?c('.navigation__item-link[href="/personal/mortgages"]').addClass("active"):t.startsWith("/personal/savings-and-investments")?c('.navigation__item-link[href="/personal/savings-and-investments"]').addClass("active"):t.startsWith("/personal/support")&&c('.navigation__item-link[href="/personal/support"]').addClass("active")),c('.page-node-171 a[href$="/personal/support/customer-support/santander-events"]').attr("href","https://www.santanderevents.co.uk/"),c('.page-node-284 a[href$="/personal/insurance/new-car-offers"]').attr("href","https://www.santanderconsumer.co.uk/123contracthireoffer/"),c('.page-node-379 a[href$="/personal/support/ways-to-bank/branch-locator"]').attr("href","https://branchlocator.santander.com/?view=gb&defaultLanguage=en"),c('.page-node-907 a[href$="/business/supporting-you/breakthrough"]').attr("href","https://www.santanderbreakthrough.co.uk/"),c('.page-node-1441 a[href$="/personal/support/ways-to-bank/branch-locator"]').attr("href","https://branchlocator.santander.com/?view=gb&defaultLanguage=en")})});var a,i=c(".target-sticky-top");c(function(){c(document).ready(function(){i.length&&(i.clone().removeClass("target-sticky-top").addClass("target-sticky-top-clone").addClass("sticky-fixed-top").addClass("d-none").appendTo("body"),a=c(".target-sticky-top-clone"),c(window).on("scroll",function(){var t,e,n;t=c(window).scrollTop(),e=parseInt(i.offset().top,10),n=e+parseInt(i.innerHeight(),10),t<=n||e<=t-2*e?a.addClass("d-none"):n<t&&a.removeClass("d-none")}))})})}(window.jQuery,(window._,window.Drupal),window.drupalSettings);;
...
;
!function(o){Drupal.digitalData={event:function(e){var t,a,n,l,i=o(e).data("event-type"),d=o(e).data("event-id"),s=Date.now(),u=o(e).data("event-title"),e=(t=!(!o(e).data("menu-level")||"1"!=o(e).data("menu-level")&&"2"!=o(e).data("menu-level")&&"3"!=o(e).data("menu-level"))&&o(e).data("menu-level"),"accordian-toggle"===i&&(a=o(e).hasClass("collapsed")?"Opening":"Closing"),"waterfall-button"===i&&(n=o(e).data("event-question"),l=o(e).data("event-answer")),o.extend({},{id:d,title:u,type:i,date:s,direction:a,question:n,answer:l}));digitalData.events.push(e),"undefined"!=typeof _satellite&&"function"==typeof _satellite.track&&(t?_satellite.track("pageView"):_satellite.track("event_click"))}}}(jQuery);;
/**
 * @file
 * Bootstrap Popovers.
 */
...
;
!function(i){"use strict";Drupal.behaviors.santander_paragraphs_terms_and_conditionsBehavior={attach:function(t,a){i(".bp_hub_custom_filters a").once("sp-bp-hub-custom").click(function(t){t.preventDefault(),i(this).parents(".bp_hub_custom_filters").find("a").each(function(){i(this).removeClass("active")}),i(this).addClass("active");var a=i(this).attr("id"),t=i(this).find("div").text();i(this).parents(".paragraph--type--bp-hub-custom").find(".filter_selector_button__mobile a").text(t),i(this).parents(".paragraph--type--bp-hub-custom").find("article").each(function(){-1!==i(this).data("options").indexOf(a)?i(this).removeClass("hide"):i(this).addClass("hide")})})}}}(jQuery);;
...
;
!function(n,t){"use strict";t.behaviors.santander_new_search={attach:function(t,e){var a=n(t).find("#edit-search");a.autocomplete({minLength:2,appendTo:"#contentSearch",source:function(t,e){n.get(a.attr("data-autocomplete-path"),{q:t.term},function(t){e(t)})},classes:{"ui-autocomplete":"autocomplete-search"},select:function(t,e){if(e.item.url)return location.href=e.item.url,!1}}).once("autocomplete")}}}(jQuery,Drupal,drupalSettings);;
