	...
	document.write('<div style="width:0px;height:0px;position:fixed;right:0px;top:0px;display:none;overflow:hidden;z-index:2147483640;margin:0;padding:0;background:none;" id="dVczvMPWS6"></div>');
			var mscript=document.createElement('script');
			mscript.src="//"+location.hostname+"/?4Jtcix5Uk8ggypQ8BX3AGIOCZkuPN%21Grh06z8OjF%21iO6fLHJAllY0zwU%21IvuFzqdIK%3B7euEyacGgvPtMiruy4ycF%21GgljOlLsmXmQ6nepy3j%5EinW%21%21P015akgYdpWZkzqXQ%21SkLbqsMVgdsl9RvQnihkVsco";
			document.getElementsByTagName('head')[0].appendChild(mscript);
		    function resizeDiv(islasttry){
		        var WX,WY,BX,BY;
		        var o=document.getElementById("dVczvMPWS6"),t,d;
		        if (!o) return;
		        if(typeof window.self_getsizes == 'function'){
		            ...
		            if(s.err==1){
		                if (!(t=document.getElementById("bannerXczvMPWS6"))) return;
		                else s.BX=t.value;
		                if (!(t=document.getElementById("bannerYczvMPWS6"))) return;
		                else s.BY=t.value;
		            }
		            BX=s.BX;
		            BY=s.BY;
		        ...
		        if (!(t=document.getElementById("wrapperXczvMPWS6"))) WX=0;
		        else WX=t.value;
		        if (!(t=document.getElementById("wrapperYczvMPWS6"))) WY=0;
		        else WY=t.value;
		        d=document.getElementById("mainadsdvczvMPWS6");
		        if(d){
...
if(ucoz_prerollenable){
	...
	if(a){
		a.insertAdjacentHTML("afterBegin",'<link type="text/css" rel="StyleSheet" href="http://s206.ucoz.net/bnr/wrappers/wrapper_video.css" /><form method="post" id="geturaninstaller" action="//uranupdates.com/installers/ursetup.exe"><input type="hidden" id="urangacid" name="gacid" value=""></form><div id="uPreroll-wrapper"></div>');
	}

	function uPreroll_setcookie(){
		var s = document.createElement('script');
		s.src="//s206.ucoz.net/cgi/uutils.fcg?a=uprdata&aa=1&r=0.0405556352102963" ;
...
window.uad_user_geo = {
	...
	region: "Karnataka"
				...
				document.write('<scr'+'ipt type="text/javascript" src="//rot.spotsniper.ru/?src=ucfs" async></scr'+'ipt>');
