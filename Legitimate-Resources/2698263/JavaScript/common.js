if (typeof(COMMON_JS) == 'undefined') { // 한번만 실행
    ...
    // 폼메일 창
    function win_formmail1(wr_id)
    {
	        win_open(g4_path+"/" + "adm/contents_admin/form_mail.php?wr_id="+wr_id, "winFormmail", "left=50, top=50, width=650, height=620, scrollbars=0");
    }
