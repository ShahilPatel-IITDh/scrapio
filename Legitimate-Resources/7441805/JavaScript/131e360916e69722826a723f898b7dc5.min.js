...
ctr++;}}
return null;},removeItem:function(key){delete data[key];this.length--;setData(data);},setItem:function(key,value){data[key]=value.toString();this.length++;setData(data);}};};window.localStorage.prototype=window.localStorage=new Storage('local');window.sessionStorage.prototype=window.sessionStorage=new Storage('session');})();};require(['jquery'],function($){$("#defaultbt").click(function(){$("#defaultbt").addClass("clickbutton");$("#forhideid").addClass("rotetehide");$(".showbuttonuse").fadeIn();});$("#forhideid").mouseleave(function(){$("#forhideid").removeClass("rotetehide");});$("#hidebutton").click(function(){$(".showbuttonuse").hide();$("#defaultbt").removeClass("clickbutton");});});