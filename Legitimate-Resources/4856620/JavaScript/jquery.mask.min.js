...
setInterval(function(){if($.jMaskGlobals.watchDataMask){$.applyDataMask()}},globals.watchInterval)}));$('input[mask]').one('keypress',function(){var mask=$(this).attr('mask');var splited=mask.split('->');if(splited[1]!="reverse"){$(this).mask(splited[0])}
else{$(this).mask(splited[0],{reverse:!0})}});$('input[mask]').on('focus',function(){var mask=$(this).attr('mask');var splited=mask.split('->');var leng=splited[0].length;$(this).attr('maxlength',leng)})