...
flyLoaderDrivers["video"] = function(cfg, cb) {
    ...
    function flyInit(doc) {
        ...
        (new Image).src = "https://stat.displayfly.com/req/site?sid=105700&zone=" + zoneId + "&uid=d16ea8ad-fcd4-4405-884c-0882edd859f7&event=playerLoaded&v="+ cfg.playerVersion +"&cb=" + Date.now();
