...
lo_Box_Contacto_Wp.validar            = "whatsapp_wp,nombre_wp";
...
function Enviar_whatsapp() {
    ...
    top.location.href = "https://api.whatsapp.com/send?phone="+ document.getElementById('whatsapp_wp').value +"&text=Hola soy "+ document.getElementById('nombre_wp').value + "";
