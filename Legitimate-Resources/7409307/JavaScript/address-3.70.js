 ...
 *
 * web-1-4 13/07/2023 18:43:57
 */
//3.70 - Changed source location
    ...
    */
    pca.Address = function (fields, options) {
        ...
        * @type {string} */
        ...
        address.options.countries.codesList = address.options.countries.codesList || "";
        ...
        address.options.countries.list = address.options.countries.list || pca.extend({}, address.options.list);
        ...
        address.options.bar.visible = typeof address.options.bar.visible == "boolean" ? address.options.bar.visible : false;
        ...
        address.options.bar.logoTitle = address.options.bar.logoTitle || "Powered by www.pcapredict.com";
        address.options.bar.logoUrl = address.options.bar.logoUrl || "http://www.pcapredict.com/";
        address.options.search = address.options.search || {};
        address.options.search.limit = address.options.search.limit || address.options.maxItems;
        address.options.search.origin = address.options.search.origin || address.options.countries.defaultCode || "";
        address.options.search.countries = address.options.search.countries || address.options.countries.codesList || "";
        address.options.search.datasets = address.options.search.datasets || "";
        address.options.search.language = address.options.search.language || "";
       ...
       * @fires display */
        ...
        * @param {Object} suggestion - The selected item from a find service response. */
        address.select = function (suggestion) {
            ...
            suggestion.Type === "Address" ? address.retrieve(suggestion.Id) : filterSearch();
            return address;
        }
