...
<head>
	...
	<script>
		...
		NPC.getCrDateTime = '21/07/2023T15:32:05.439+0200'; 
		...
		<div class="pushMultiple pushMultiple--container">
			...
			<ul class="pushMultiple-list js-pushMultiple">
					...
					data-tracking-conversion_avant_vente_univers_de_besoin="emprunt">
								...
								<div class="BlockLink"
									onclick="NPC.redirectToSimuIhml('4f3c736d-e7bd-4c8d-b7a0-54cf30f4ccb1', false, '/ca-des-savoie/particulier/operations/noeuds-ihml/simulateur-digiconso.html?code_simulateur=L2NvbnRlbnQvY2EvY3I4ODEvbnBjL2ZyL3BhcnRpY3VsaWVyL3NpbXVsYXRpb24tZGV2aXMvY3JlZGl0cy9zaW11bGF0ZXVyLWNyZWRpdC1jb25zbw%3D%3D')"
									data-toggle="modal">
...
<div id="4f3c736d-e7bd-4c8d-b7a0-54cf30f4ccb1" class="modal Modal Modal" role="dialog">
    <div class="Modal-dialog">
        <div class="Modal-content">
            ...
            <div class="Modal-body Modal-popin-body">
                ...
                <div class="Modal-actions">
					...
					data-tracking-conversion_avant_vente_univers_de_besoin="emprunt">
								...
								<div class="BlockLink"
									onclick="NPC.redirectToSimuIhml('da94e735-5359-4e18-b821-9869fb74eb7b', false, '/ca-des-savoie/particulier/operations/noeuds-ihml/simulateur-digiconso.html?code_simulateur=L2NvbnRlbnQvY2EvY3I4ODEvbnBjL2ZyL3BhcnRpY3VsaWVyL3NpbXVsYXRpb24tZGV2aXMvY3JlZGl0cy9zaW11bGF0ZXVyLWNyZWRpdC1hdXRv')"
									data-toggle="modal">
									<div class="BlockLink-cell BlockLink-cell--icon">
										<img class="BlockLink-icon" src="/content/dam/assetsca/master/public/commun/images/pictogramme/pictos-cp/Cr̩dit%20conso.svg" alt=""/>
									</div>
...
<div id="da94e735-5359-4e18-b821-9869fb74eb7b" class="modal Modal Modal" role="dialog">
    <div class="Modal-dialog">
        <div class="Modal-content">
            <div class="Modal-header-without-border">
                <button type="button" class="Modal-popin-close" data-dismiss="modal" aria-label="Close"></button>
		...
		<div class="pushMultiple pushMultiple--container">
			...
			<ul class="pushMultiple-list js-pushMultiple">
					...
					data-tracking-conversion_avant_vente_univers_de_besoin="assurance">
                                ...
                                <div class="BlockLink" onclick="NPC.redirectIfConnectedOrOpenModal('55681ea6-283d-45ce-8c26-6e8feddb0271', '/ca-des-savoie/particulier/operations/moco/pacifica/_jcr_content.init.html?situation_travail=DEVHABI&codeOffre=DEVHABI')" data-toggle="modal">
                                    <div class="BlockLink-cell BlockLink-cell--icon">
...
<div id="55681ea6-283d-45ce-8c26-6e8feddb0271" class="modal Modal Modal" role="dialog">
    <div class="Modal-dialog">
        <div class="Modal-content">
            <div class="Modal-header-without-border">
                <button type="button" class="Modal-popin-close" data-dismiss="modal" aria-label="Close"></button>
            ...
            <div class="Modal-body Modal-popin-body">
                ...
                <div class="Modal-actions">
					...
					data-tracking-conversion_avant_vente_univers_de_besoin="assurance">
                                ...
                                <div class="BlockLink" onclick="NPC.redirectIfConnectedOrOpenModal('7f193e9d-f8b7-4987-8c46-cb8148621cbf', '/ca-des-savoie/particulier/operations/moco/pacifica/_jcr_content.init.html?situation_travail=DEVAUTO&codeOffre=')" data-toggle="modal">
                                    <div class="BlockLink-cell BlockLink-cell--icon">
...
<div id="7f193e9d-f8b7-4987-8c46-cb8148621cbf" class="modal Modal Modal" role="dialog">
    <div class="Modal-dialog">
        <div class="Modal-content">
            <div class="Modal-header-without-border">
                <button type="button" class="Modal-popin-close" data-dismiss="modal" aria-label="Close"></button>
		...
		<div class="pushMultiple pushMultiple--container">
			...
			<ul class="pushMultiple-list js-pushMultiple">
					...
					data-tracking-conversion_avant_vente_univers_de_besoin="assurance">
                                ...
                                <div class="BlockLink" onclick="NPC.redirectIfConnectedOrOpenModal('d804a56b-5523-46de-b376-6d122bcd04d3', '/ca-des-savoie/particulier/operations/moco/pacifica/_jcr_content.init.html?situation_travail=DEVSANTE&codeOffre=AUTRE')" data-toggle="modal">
                                    <div class="BlockLink-cell BlockLink-cell--icon">
...
<div id="d804a56b-5523-46de-b376-6d122bcd04d3" class="modal Modal Modal" role="dialog">
    <div class="Modal-dialog">
        <div class="Modal-content">
            <div class="Modal-header-without-border">
                <button type="button" class="Modal-popin-close" data-dismiss="modal" aria-label="Close"></button>
            ...
            <div class="Modal-body Modal-popin-body">
                ...
                <div class="Modal-actions">
					...
					data-tracking-conversion_avant_vente_univers_de_besoin="assurance">
                                ...
                                <div class="BlockLink" onclick="NPC.redirectIfConnectedOrOpenModal('b428afdc-c4cd-4308-8e3d-c87ccb65a16f', '/ca-des-savoie/particulier/operations/moco/pacifica/_jcr_content.init.html?situation_travail=DEVGAV&codeOffre=AUTRE')" data-toggle="modal">
                                    <div class="BlockLink-cell BlockLink-cell--icon">
...
<div id="b428afdc-c4cd-4308-8e3d-c87ccb65a16f" class="modal Modal Modal" role="dialog">
    <div class="Modal-dialog">
        <div class="Modal-content">
            <div class="Modal-header-without-border">
                <button type="button" class="Modal-popin-close" data-dismiss="modal" aria-label="Close"></button>
