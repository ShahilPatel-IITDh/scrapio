...
hS=0,hC=0,srr=T('(espace-client)?@/.*-sre(/|$)'),yt=_('meta[content*=CLISMR]')[0]?'&yt':'',vH=21,
hdr=_.hdr=function(t){hC||JS(hC=
srr?'*hdrre|Ist'+yt:
_.nr?rbs+'fragments/header/header.standard'+(t?'.tunnel':'')+'|Ist':t?'*ettun|Ist':'*hdr'+vH+'|Ist'+(
...
eP=_.eP=function(j,p,f,b){JS((b?ist:dom)+'sgjo/'+j+(p?'?'+p:''),f)},
tc=function(){
...
(b?DJ:dj)+(_.hdrP=hS?'hdr'+vH+'|Ist&U=E':'hdrec|Ist'))+(b?'&D='+r9:''))},
...
ab(774,2)
ab(686,b<50?1:2)
if(vH>22)ST('#eThS{visibility:hidden}')
ab(389,3)
v=ckR('eTab389')
...
var VL=[209,16760832,"",3072],
...
if(!W.AMP){_.onL=W.onload;W.onload=function(){if(!W._eTf)JS(ist+'sgfo.js');_.onL&&_.onL()}}
