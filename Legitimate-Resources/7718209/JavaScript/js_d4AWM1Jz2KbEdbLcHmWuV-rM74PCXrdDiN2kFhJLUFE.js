...
(function ($, Drupal) {
  ...
  Drupal.behaviors.antaiMenu = {
    attach: function (context) {

      $(document).ready(
           function () {
             var menu0 = $('.menu-level0 a');
             var menu1 = $('.navbar[aria-label="menu-lvl-1"] a');
             var menu2 = $('.navbar[aria-label="menu-lvl-2"] a');
             ...
             menu2.each(function (){
                ...
                if (pathname === href || pathname === href + '/'){
                  itemmenutrouve = true;
                  var mainmenu = $(this).parents("ul").attr("id").substr(7,1);
                  var nummenu = $(this).parents("ul").attr("id").substr(7);
                  var submenu = $('.navbar[aria-label="menu-lvl-1"]').find('ul[id="submenu'+mainmenu+'"]');
                  submenu.show();
                  var mainprofil = $('.menu-level0').find('li[id="main-profil-'+mainmenu+'"]');
                  mainprofil.addClass('active');
                  submenu.find('li[id="main-submenu'+nummenu+'"]').addClass('current');
                }
             });
             ...
             if (!itemmenutrouve){
               menu1.each(function (){
                 ...
                 if (pathname === href || pathname === href + '/'){
                   itemmenutrouve = true;
                   var mainmenu = $(this).parents("ul").attr("id").substr(7);
             ...
             if (!itemmenutrouve){
               menu0.each(function (){
                 var href = $(this).prop('href');
                 if (pathname === href || pathname === href + '/'){
                   var mainprofil = $(this).parents("li");
                   mainprofil.addClass('active');
                   var nummenu = mainprofil.attr('id').substr(12);
                   var submenu = $('.navbar[aria-label="menu-lvl-1"]').find('ul[id="submenu'+nummenu+'"]');
                   submenu.show();
                 }
               });
             }
             ...
             // affichage du menu de niveau 2 correspondant au menu de niveau selectionné
             if ($('.menu-level0 > .menu0-item').hasClass('active')){
               var eltactif = $('.menu-level0 > .menu0-item.active');
               $('#submenu' + eltactif[0].id.split('main-profil-')[1]).css('display','flex');
               $('#submenu' + eltactif[0].id.split('main-profil-')[1]).css('flex-wrap','wrap');
             }
             else {
               var defautactif = $('.menu-level0 > .menu0-item');
               $('#submenu' + defautactif[0].id.split('main-profil-')[1]).css('display','flex');
               $('#submenu' + defautactif[0].id.split('main-profil-')[1]).css('flex-wrap','wrap');
             }

             // mise en evidence du menu de niveau 2 courant
             // + affichage du menu de niveau 3 correspondant
             if ($('.menu-level1 > .item-submenu1').hasClass('current')){
               var eltcurrent = $('.menu-level1 > .item-submenu1.current');
               if ($('#' + eltcurrent[0].id.split('main-')[1]).hasClass('menu-level2')) {
                 $('.submenu-info').show();
                 $('.menu-level2').hide();

                 $('#' + eltcurrent[0].id.split('main-')[1]).css('display', 'flex');
                 $('#' + eltcurrent[0].id.split('main-')[1]).css('flex-wrap', 'wrap');
               }
             }
             else {
               var menu1actif = $('.menu-level0 > .menu0-item.active');
               var lienparent = menu1actif.children('a').attr('href');
               var nummenu = menu1actif[0].id.split('main-profil-')[1];
               $('#submenu' + nummenu).children().each(function (){
                 if ($(this).children('a').attr('href') == lienparent){
                    if (!$(this).hasClass('current')){
                      if ($('#' + $(this)[0].id.split('main-')[1]).hasClass('menu-level2')){
                        $('.submenu-info').show();
                        $('.menu-level2').hide();

                        $('#' + $(this)[0].id.split('main-')[1]).css('display', 'flex');
                        $('#' + $(this)[0].id.split('main-')[1]).css('flex-wrap', 'wrap');
                      }
                    }
                 }
               });
             ...
             if (!$('#antai-toggle-menu > .navbar-nav > .mobile0-item').hasClass('active')){
               var mobiledefautactif = $('#antai-toggle-menu > .navbar-nav > .mobile0-item');
               $('#' + mobiledefautactif[0].id).addClass('active');
             }

             if ($('#antai-toggle-menu').hasClass('in')){
               $('#topmenu_mobile').hide();
             }
             else{
               $('#topmenu_mobile').show();
             ...
             if (!$('#topmenu_mobile > .btn-group > .dropdown-menu > .select-profil').hasClass('active')){
               var selectdefaultactif = $('#topmenu_mobile > .btn-group > .dropdown-menu > .select-profil');
               $('#' + selectdefaultactif[0].id).addClass('active');
               var dropdowndefaultactif = $('#topmenu_mobile > .btn-group > .dropdown-toggle > .select-profil');
               $('#' + dropdowndefaultactif[0].id).addClass('active');

             }

             var top = $('.sticky-scroll').offset().top;
      ...
      $('#antai-toggle-menu').once().on('shown.bs.collapse', function(e){
          $('#topmenu_mobile').hide();
          var profilagemobile = $('#antai-toggle-menu > .navbar-nav > .mobile0-item.active')
          $('#' + profilagemobile[0].id).addClass('open');
      });

      $('#topmenu_mobile > .btn-group > .dropdown-menu > .select-profil').once().on('click', function (e) {
        if (!$(this).hasClass('active')){
          var selectactif = $('#topmenu_mobile > .btn-group > .dropdown-menu > .select-profil.active');
          var dropdownactif = $('#topmenu_mobile > .btn-group > .dropdown-toggle > .select-profil.active');
          $('#' + selectactif[0].id).removeClass('active');
          $('#' + dropdownactif[0].id).removeClass('active');
          $('#' + $(this)[0].id).addClass('active');
          $('#select-profil-' + $(this)[0].id.split('mobile-profil-')[1]).addClass('active');
        }
      });
...
(function ($, Drupal) {
  ...
  Drupal.behaviors.antaiAccordion = {
    attach: function (context) {

      $('.lunr-search-results').on('show.bs.collapse','.collapse', function() {
        var parent = $(this).parent();
        var chevron_ouvert = parent[0].getElementsByClassName('fa-chevron-up');
        chevron_ouvert[0].style.display = "inline-block";
        var chevron_ferme = parent[0].getElementsByClassName('fa-chevron-down');
        chevron_ferme[0].style.display = "none";
        var encadre = parent[0].getElementsByClassName('encadre-accordeon');
        encadre[0].classList.add('selected');
        $('.lunr-search-results').find('.collapse.in').collapse('hide');
      });

      $('.lunr-search-results').on('hide.bs.collapse','.collapse', function() {
        var parent = $(this).parent();
        var chevron_ouvert = parent[0].getElementsByClassName('fa-chevron-up');
        chevron_ouvert[0].style.display = "none";
        var chevron_ferme = parent[0].getElementsByClassName('fa-chevron-down');
        chevron_ferme[0].style.display = "inline-block";
        var encadre = parent[0].getElementsByClassName('encadre-accordeon');
        encadre[0].classList.remove('selected');
      });

      $('.bloc-accordeons').on('show.bs.collapse','.collapse', function () {
        $('.bloc-accordeons').find('.collapse.in').collapse('hide');
      });

      $('.accordeon > .reponse').on('hide.bs.collapse', function () {
        var parent = $(this).parent();
        var chevron_ouvert = parent[0].getElementsByClassName('fa-chevron-up');
        chevron_ouvert[0].style.display = "none";
        var chevron_ferme = parent[0].getElementsByClassName('fa-chevron-down');
        chevron_ferme[0].style.display = "inline-block";
        var bloc_question = parent[0].getElementsByClassName('bloc-question');
        bloc_question[0].classList.remove('selected');
      })

      $('.accordeon > .reponse').on('show.bs.collapse', function () {
        var parent = $(this).parent();
        var chevron_ouvert = parent[0].getElementsByClassName('fa-chevron-up');
        chevron_ouvert[0].style.display = "inline-block";
        var chevron_ferme = parent[0].getElementsByClassName('fa-chevron-down');
        chevron_ferme[0].style.display = "none";
        var bloc_question = parent[0].getElementsByClassName('bloc-question');
        bloc_question[0].classList.add('selected');
      })
...
(function ($, Drupal) {
  ...
  Drupal.behaviors.antaiLanguage = {
    attach: function (context) {

      $(document).ready(
          function(){
            var langactif;
            if ($('.language-link').hasClass('is-active')) {
              langactif = $('.language-link.is-active')[0].getAttribute('hreflang');
            }
            else {
              var pathname = window.location.pathname;
              if (pathname.substring(1,3) != 'en' &&
                  pathname.substring(1,3) != 'it' &&
                  pathname.substring(1,3) != 'de' &&
                  pathname.substring(1,3) != 'es' &&
                  pathname.substring(1,3) != 'nl'){
                langactif = 'fr';
              }
              else {
                langactif = pathname.substring(1,3);
              }
            }

            switch (langactif) {
              case 'fr':
                $('#lang-selector').addClass('margin-right-173');
                break;
              case 'en':
                $('#lang-selector').addClass('margin-right-140');
                break;
              case 'de':
                $('#lang-selector').addClass('margin-right-107');
                break;
              case 'it':
                $('#lang-selector').addClass('margin-right-75');
                break;
              case 'nl':
                $('#lang-selector').addClass('margin-right-42');
                break;
              case 'es':
                $('#lang-selector').addClass('margin-right-8');
                break;
            }

            if ((window.location.pathname).includes('/faq') ||
              (window.location.pathname).includes('/actualites')) {
              var languageLinks = $('.language-switcher-language-url a');
              var search = window.location.search;
              languageLinks.each(function () {
                var href = $(this).prop('href');
                var search_begin = href.indexOf("?");
                $(this).prop('href', href.substr(0,search_begin) + search);
              });
            }
          }
      );
...
(function ($, Drupal) {
  ...
  Drupal.behaviors.antaiFiltreRecherche = {
    attach: function (context) {
      $(document).ready(
          function(){

            $('.lunr-search-page-form > .panel-default > .panel-body > .bouton').each(function (){
              if (window.location.href.substring(window.location.href.search(window.location.pathname)) === $(this).attr('href')){
      ...
      $('.lunr-search-page-form > .panel-default > .panel-body > .bouton').once().on('click', function (e) {
        if ($(this).hasClass('btn-default')){
          ...
          if (window.location.pathname == '/recherche'){
            ...
            if (recherche !== null) {
              location.href = window.location.origin + window.location.pathname + '?search=' + recherche
            }
            else {
...
(function ($, Drupal) {
  ...
  Drupal.behaviors.antaiCarousel = {
    attach: function (context) {
...
(function ($, Drupal) {
  ...
  Drupal.behaviors.antaiTable = {
    attach: function (context) {
      $(document).ready(
        function(){
          var styles = [];
          $('.editorial table').each(function () {
          ...
          checkMediaQuery(styles);
          window.addEventListener('resize',function (){checkMediaQuery(styles)});
        }
      );
      function checkMediaQuery(styles){
        if (window.innerWidth < 991){
          ...
          $('.editorial table').each(function (index, value) {
            var style = $(this).attr('style');
            if ((typeof style == typeof undefined || style == false) && styles) {
              $(this).attr('style', styles[index]);
            }
          });
        }
      }
      ...
      $('.editorial table').each(function () {
            ...
            if (typeof cs !== typeof undefined && cs !== false){
              $(this).removeAttr('cellspacing');
            }
            var cp = $(this).attr('cellpadding');
            if (typeof cp !== typeof undefined && cp !== false){
              $(this).removeAttr('cellpadding');
            }
            var align = $(this).attr('align');
            if (typeof align !== typeof undefined && align !== false){
              $(this).removeAttr('align');
            }
            var border = $(this).attr('align');
            if (typeof border !== typeof undefined && border !== false){
              $(this).removeAttr('border');
            }
      });
      $('.editorial table th').each(function () {
...
(function ($, Drupal) {
  ...
  Drupal.behaviors.antaiRogerVoice = {
    attach: function (context) {
      $(document).ready(function (){
        var ORGANIZATION_KEY = 'mWB5z43v8h';
      ...
      $('.btn-rogervoice').once().click(function (){
        Rogeraccess('open');
      });
    }
  }
