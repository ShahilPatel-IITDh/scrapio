    ...
    window.BuroRaDer.DateRangePicker = {
        ...
        _updateDatepicker: function (inst) {
            ...
            if (inst !== null) {
                ...
                var cleartext = $('#tresult-cleartext').text();
                var applytext = $('#tresult-applytext').text();

                //var clear = $('<div class="clear-action"  data-handler="reset" data-event="click"><a>' + this._get(inst, "clearText") + '</a></div>');
                var clear = $('<div class="apply-btn clear-bt"  data-handler="reset" data-event="click"><a>' + cleartext + '</a></div>');
                var done = $('<div  class="apply-btn apply-bt"  data-handler="hide" data-event="click"><a>' + applytext + '</a></div>');
                ...
                clear.click(function () {
                    ...
                    setTimeout(function () { $("#startDate").datepicker('show'); }, 100);
        ...
        _clearDate: function (input) {
            ...
            if (inst !== null) {
                inst.rangeStart = null;
                var today = new Date();
                //var _defaultDate = today.getMonth() + 1 + '/' + today.getDate() + '/' + today.getFullYear();
                var _defaultDate = '';
                $(inst.inputStart).val(_defaultDate);
                inst.rangeEnd = null;
                $(inst.inputEnd).val("");
