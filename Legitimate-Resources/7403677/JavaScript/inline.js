    ...
    (function($) {
      ...
      var reset_pass_email = utils.getParamValue("reset_pass_email");
      if(reset_pass_email !== ''){
        $loginEmail.val(reset_pass_email)
      }
                    ...
                    success: function(data) {
                        ...
                        switch (data.code) {
                            case "OK":
                                ...
                                window.location.href = utils.parseMultiLink("/activate-account/"); //添加注册新账户,邮箱激活
                                break;
                            ...
                            case "5": //邮箱地址错误
                                ...
                                break;
                            default:
                                $signUpHelp.removeClass("cc-hide").html(fh5.pageData.tips.UnexpectedError2);
                                hasError = true;
                        }
