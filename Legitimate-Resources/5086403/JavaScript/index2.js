...
function ajaxRequst(e, t) {
    var lotteryType = $(t).attr("lotteryType");
    var code = $(t).attr("id");
    if (!code)
        return;
    if (code.match(/_hot$/g))
        code = code.substr(0, code.length - 4);
    switch (lotteryType) {
        case 'pk10':
            indexObj.ajaxpk10(e, code, t);
            break;
        case 'ssc':
            indexObj.ajaxSsc(e, code, t);
            break;
        case 'klsf':
            if (code == 'xync') {
                indexObj.ajaxCqnc(e, code, t);
            }
            else {
                indexObj.ajaxKlsf(e, code, t);
            }
            break;
        case 'k3':
            indexObj.ajaxKuai3(e, code, t);
            break;
        case '11x5':
            indexObj.shiyix5(e, code, t);
            break;
        case 'pl3':
            indexObj.ajaxTcpl3(e, code, t);
            break;
        case 'pl5':
                indexObj.ajaxTcpl5(e, code, t);
                break;
        case 'tc7xc':
            indexObj.ajaxTc7xc(e, code, t);
            break;
        case 'xy28':
            indexObj.ajaxXy28(e, code, t);
            break;
        case 'hk6':
            indexObj.ajaxHk6(e, code, t);
            break;
    }
}
...
function iframe(e) {
    var t = {
        ...
        xy28: "/js/lib/video/pcEgg_video/index.html",
    }, a = {
        pk10: "北京PK10",
        cqssc: "重庆时时彩",
        tjssc: "天津时时彩",
    ...
    $("#videoIframe").find("iframe").attr("src", t[e].startsWith("/") ? t[e] : "//kj.kai861.com/view/video/" + t[e])
}

$(function () {
    $(".view_box div[lotteryType]").each(function () {
        ajaxRequst("", "#" + $(this).attr("id"));
    });
    ...
    indextools.userXahao("pk10", 10, 50);
    indextools.userXahaoSsc("cqssc", 10, 50);
});
var publicUrl = config.publicUrl, imgUrl = config.imgUrl, indexObj = new Object, indextools = {}, bannernews = "",
    fanganyc = "";
indexObj.ajaGxklsf = function (e, t, a) {
...
}, indexObj.ajaxHk6 = function (e, t, a) {
    var e = void 0 == e ? "" : e, n = !1;
    $.ajax({
        url: publicUrl + "6h/getHk6Info.do",
        type: "GET",
        data: {lotCode: t},
        timeout: 6e4,
        beforeSend: function () {
            if (void 0 == animateID[a]) {
                animateMethod.hk6Animate(a);
            }
            ;
        },
        success: function (n) {
            try {
                indexObj.hk6Data(n, t, a);
...
}, indexObj.hk6Data = function (e, t, a) {
    var n = tools.parseObj(e);
    n = n.result.data;
    if (tools.operatorTime("" == n.drawTime ? "0" : n.drawTime, n.serverTime) <= 0)
        throw new Error("error");
    var i = n.totalCount;
    $(a).find(".preDrawIssue").text(n.preDrawIssue);
    $(a).find(".sdrawCountnext").text(1 * i - 1 * n.drawCount);
    $(a).find(".sumNum").text(n.sumTotal);
    $(a).find(".sumSingleDouble").text(0 == n.sumSingleDouble ? "单" : "双");
    $(a).find(".sumBigSmall").text(0 == n.sumBigSmall ? "大" : "小");
    $(a).find(".specialBigSmall").text(0 == n.seventhBigSmall ? "大" : "小");
    $(a).find(".specialSingleDouble").text(0 == n.seventhSingleDouble ? "单" : "双");
    $(a).find(".specialHeBigSmall").text(0 == n.seventhCompositeBig ? "合大" : "合小");
    $(a).find(".specialHeSingleDouble").text(0 == n.seventhCompositeDouble ? "合单" : "合双");
    $(a).find(".specialTailBigSmall").text(0 == n.seventhMantissaBig ? "尾大" : "尾小");
    animateMethod.hk6AnimateEnd(n, a);
    tools.countDown(n.drawTime, n.serverTime, a)
    ...
    var n = !1;
    $.ajax({
        url: config.publicUrl + "QuanGuoCai/getLotteryInfo.do?issue=" + e,
        type: "GET",
        data: {lotCode: t},
        beforeSend: function () {
            void 0 == animateID[a] && animateMethod.sscAnimate(a)
...
}, indexObj.ajaxTcpl5 = function (e, t, a) {
    var n = !1;
    $.ajax({
        url: config.publicUrl + "QuanGuoCai/getLotteryInfo.do?issue=" + e,
        type: "GET",
...
}, indexObj.ajaxXy28 = function (e, t, a) {
    var n = !1;
    $.ajax({
...
}, indexObj.ajaxTc7xc = function (e, t, a) {
    var n = !1;
    $.ajax({
        url: config.publicUrl + "QuanGuoCai/getLotteryInfo.do?issue=" + e,
        type: "GET",
    ...
    $(t).find(".sumNum").html(a.sumNum);
    $(t).find(".sumBigSmall").html(a.sumBigSmall != 1 ? '小' : '大');
    $(t).find(".sumSingleDouble").html((a.sumSingleDouble % 2 != 0 ? "单" : "双"));
        ...
        success: function (e) {
            if ("object" == typeof(e = e) || (e = JSON.parse(e)), "0" == e.errorCode) if ("0" == e.result.businessCode) {
                ...
                bannernews = e.result.data, $(e.result.data).each(function () {
                    t += "<p><a target='_blank' href='html/zixunhtml/zx_detail.html?" + this.newsId + "'>" + this.title + "</a></p>"
                }), $("#bannernews").append(t)
...
$(function () {
    ...
    var o = "";
    $.each(a, function (a, n) {
        o += "<li><div class='head_div'><a href='html/zsh/index.html?lottype=pk10_Kill'> <img src='img/head_png/headicon_" + a + ".png' /></a>", o += "<span>" + config.Uname[a] + "</span> </div><div class='result'>", o += "<h3>最新冠军杀号: <span>" + n + "</span></h3><p>近10期成功率： <span class='clo_red'>" + t[e + "Percent"][a] + "</span></p>", o += "<p>历史战绩： <span>" + t[e + "HisPercent"][a] + "</span></p></div></li>"
    ...
    var o = "";
    $.each(a, function (a, n) {
        o += "<li><div class='head_div'><a href='html/zsh/index.html?lottype=cqssc_Kill'> <img src='img/head_png/headicon_" + a + ".png' /></a>", o += "<span>" + config.SscUname[a] + "</span> </div><div class='result'>", o += "<h3>最新冠军杀号: <span>" + n + "</span></h3><p>近10期成功率： <span class='clo_red'>" + t[e + "Percent"][a] + "</span></p>", o += "<p>历史战绩： <span>" + t[e + "HisPercent"][a] + "</span></p></div></li>"
